import{r as g,m as Re,a as Le,p as We,c as X,i as q,b as W,d as H,e as Se,T as ye,s as ce,P as G,t as Xe,f as pn,g as vn,h as Ae,j as V,k as qe,l as Ye,n as oe,o as hn,q as gn,u as xn,v as bn,w as En,x as wn,y as Nn,z as ke,A as Sn,B as yn,C as r,D as ue,E as je,F as Ze,G as Qe,H as de,I as jn,N as B,J as fe,K as In,L as Tn,M as On,O as _e}from"./CoxeterMatrix-a1a2812c.js";var Rn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function An(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}const Dn="xyzwvutsrqponmlkjihgfedcba",en=["perspective","stereographic","orthographic","klein","inverted","scale","joukowsky","half","upperhalf","halfsphere","band","cross","heart","teardrop","square","ring","sinusoidal","spiral","SC_Triangle","SC_Square","SC_Pentagon","SC_Hexagon"],Cn=["ads","normal","position","uv"],Fn=["lambert","oren-nayar","minnaert","cel","fresnel","reverse"],zn=["phong","blinn-phong","cook-torrance","ward-anisotropic"],Y=["lowest","lower","low","lowish","medium","highish","high","higher","ultra"],Ie=["vertex","edge","face"],Pn=(e,t)=>{const n=g.useRef({previous:null,anteprevious:null,start:null,stable:!1});g.useEffect(()=>{const o=16.666666666666668;if(e.adaptative){let a=null,i=null,s=[];const l=20,f=10,c=u=>{if(i===null){n.current.start===null&&(n.current.start=u),i=u,a=requestAnimationFrame(c);return}if(s.push(u-i),i=u,s.length>Re(l,f)&&s.shift(),s.length>=f&&s.slice(-f).reduce((h,v)=>h+v,0)/f>(n.current.stable?2.01:1.51)*o){s=[],n.current.stable=!1;const h=Y.indexOf(e.detail);if(h>1){n.current.anteprevious=n.current.previous,n.current.previous=e.detail;const v=Y[h-1];t(p=>({...p,detail:v}))}}if(s.length>=l&&s.slice(-l).reduce((h,v)=>h+v,0)/l<(n.current.stable?1.001:1.01)*o){s=[],n.current.stable=!1;const h=Y.indexOf(e.detail);if(h<Y.length-2){const v=Y[h+1];v===n.current.previous&&e.detail===n.current.anteprevious&&u-n.current.start>1e3?n.current.stable=!0:(n.current.anteprevious=n.current.previous,n.current.previous=e.detail,t(p=>({...p,detail:v})))}}a=requestAnimationFrame(c)};return a=requestAnimationFrame(c),()=>cancelAnimationFrame(a)}},[e.detail,e.adaptative,e.ambiance,e.space,t]),g.useEffect(()=>{n.current={previous:null,anteprevious:null,stable:!1,start:null}},[e.space,e.shaper,e.ambiance])};class he extends g.Component{constructor(t){super(t),this.state={error:!1}}static getDerivedStateFromError(t){return{error:!0}}static getDerivedStateFromProps(t){return{error:t.error}}componentDidCatch(t,n){this.props.onError(t,n)}render(){return this.state.error?null:this.props.children}}var nn={exports:{}};(function(e,t){(function(n,o){e.exports=o()})(Rn,function(){var n=function(){function o(v){return s.appendChild(v.dom),v}function a(v){for(var p=0;p<s.children.length;p++)s.children[p].style.display=p===v?"block":"none";i=v}var i=0,s=document.createElement("div");s.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",s.addEventListener("click",function(v){v.preventDefault(),a(++i%s.children.length)},!1);var l=(performance||Date).now(),f=l,c=0,u=o(new n.Panel("FPS","#0ff","#002")),m=o(new n.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=o(new n.Panel("MB","#f08","#201"));return a(0),{REVISION:16,dom:s,addPanel:o,showPanel:a,begin:function(){l=(performance||Date).now()},end:function(){c++;var v=(performance||Date).now();if(m.update(v-l,200),v>f+1e3&&(u.update(1e3*c/(v-f),100),f=v,c=0,h)){var p=performance.memory;h.update(p.usedJSHeapSize/1048576,p.jsHeapSizeLimit/1048576)}return v},update:function(){l=this.end()},domElement:s,setMode:a}};return n.Panel=function(o,a,i){var s=1/0,l=0,f=Math.round,c=f(window.devicePixelRatio||1),u=80*c,m=48*c,h=3*c,v=2*c,p=3*c,E=15*c,O=74*c,N=30*c,A=document.createElement("canvas");A.width=u,A.height=m,A.style.cssText="width:80px;height:48px";var y=A.getContext("2d");return y.font="bold "+9*c+"px Helvetica,Arial,sans-serif",y.textBaseline="top",y.fillStyle=i,y.fillRect(0,0,u,m),y.fillStyle=a,y.fillText(o,h,v),y.fillRect(p,E,O,N),y.fillStyle=i,y.globalAlpha=.9,y.fillRect(p,E,O,N),{dom:A,update:function(F,U){s=Math.min(s,F),l=Math.max(l,F),y.fillStyle=i,y.globalAlpha=1,y.fillRect(0,0,u,E),y.fillStyle=a,y.fillText(f(F)+" "+o+" ("+f(s)+"-"+f(l)+")",h,v),y.drawImage(A,p+c,E,O-c,N,p,E,O-c,N),y.fillRect(p+O-c,E,c,N),y.fillStyle=i,y.globalAlpha=.9,y.fillRect(p+O-c,E,c,f((1-F/U)*N))}}},n})})(nn);var Mn=nn.exports;const Ln=An(Mn),kn=`const vec2 cone = vec2(1., 0);
...
`),Object.entries({...Wn,config:i}).forEach(([c,u])=>{t=t.replace(`#include ${c}`,u),n=n.replace(`#include ${c}`,u)}),[t,n].map(c=>qn(c,e.dimensions))},ie=(e,t,n,o,a)=>{if(e.gl.shaderSource(a,o),e.gl.compileShader(a),!e.gl.getShaderParameter(a,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(a);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},He=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},tn=(e,t,n,o,a=[])=>{const{gl:i}=e,s=i.createProgram(),l=i.createShader(i.VERTEX_SHADER),f=i.createShader(i.FRAGMENT_SHADER);if(ie(e,t,"vertex",n,l)||ie(e,t,"fragment",o,f)||(i.attachShader(s,l),i.attachShader(s,f),He(e,t,s)))return;const c={program:s,vertexShader:l,fragmentShader:f,uniformsDef:a,recompile(u,m,h,v=null){ie(u,t,"vertex",m,this.vertexShader)||ie(u,t,"fragment",h,this.fragmentShader)||He(u,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(u))},bindUniforms(u){this.uniforms={},this.uniformsDef.forEach(({name:m,type:h,value:v})=>{this.uniforms[m]=Yn(u,this.program,m,h),this.uniforms[m].update(v)})}};return c.bindUniforms(e),c},ne=(e,t,n,o,a,i=null,s=null)=>{const{gl:l}=e;s=s||l.FLOAT;const f=s===l.FLOAT?4:2,c={name:n,mesh:t,indices:rn,instances:i,data:a,size:o,type:s,update(u=null,m=null,h=null){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer),u===null&&m===null&&h===null?l.bufferData(l.ARRAY_BUFFER,this.data,l.STATIC_DRAW):(this.data.set(u,m*this.size),l.bufferSubData(l.ARRAY_BUFFER,m*this.size*f,this.data,m*this.size,h*this.size))},extend(u,m,h=!1){if(l.bindVertexArray(this.mesh.vao),this.size=u,m&&(h&&m.length>=this.data.length&&m.set(this.data),this.data=m),this.location=l.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const v=u>4?3:1;for(let p=0;p<v;p++)l.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)l.vertexAttribPointer(this.location+p,u/v,this.type,!1,u*f,u/v*p*f);for(let p=0;p<v;p++)l.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const u=new Float32Array(this.data.length);return l.getBufferSubData(l.ARRAY_BUFFER,0,u),u}};return c.buffer=l.createBuffer(),c.extend(o),c},rn=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const a=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,a),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:a,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},Yn=(e,t,n,o)=>{const{gl:a}=e;return{program:t,update(s){if(a.useProgram(this.program),o.startsWith("m")){const l=parseInt(o.slice(1,2));if(l>4)for(let f=0;f<l;f++){const c=a.getUniformLocation(t,`${n}.c${f+1}.v`);if(c!==null&&a.uniform4fv(c,s[f][0]),l-4===1){const u=a.getUniformLocation(t,`${n}.c${f+1}.u`);u!==null&&a.uniform1f(u,s[f][1])}else if(l-4>1){const u=a.getUniformLocation(t,`${n}.c${f+1}.u`);if(u!==null&&a[`uniform${H(l-4,4)}fv`](u,s[f][1]),l-8===1){const m=a.getUniformLocation(t,`${n}.c${f+1}.t`);m!==null&&a.uniform1f(m,s[f][2])}}}else{const f=a.getUniformLocation(t,n);f!==null&&a[`uniformMatrix${o.slice(1)}`](f,!1,s)}}else{const l=a.getUniformLocation(t,n);l!==null&&a[`uniform${o}`](l,s)}},get(){a.useProgram(this.program);const s=a.getUniformLocation(t,n);if(s!==null)return a.getUniform(this.program,s)}}},$=(e,t,n=null)=>{const{gl:o}=e,a=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,a,i),{texture:s,width:a,height:i}},te=(e,t,n,o,a=[])=>{const i={name:t,vertex:n,fragment:o,...tn(e,t,n,o,a),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,a)}};return{[t]:i}},be=(e,t,n,o,a,i,s,l=["position"])=>{var h;const{gl:f}=e,c=a(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),u=v=>[{name:"viewProjection",type:"m4fv",value:X(q(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:X(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:X(q(v.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...W(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];s=s>4?9:s;const m={attributes:{},varying:l,vertex:n,type:t,fragment:o,...tn(e,t,...Ue(e,n,o,t),u(e)),recompileProgram(v){const[p,E]=Ue(v,this.vertex,this.fragment,this.type);this.recompile(v,p,E,u(v))},changeArity(v){v=v>4?9:v,this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,l.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=a(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillData(v,p){if(!p){this.count=0;return}this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v[0],p.start,p.size);for(let E=0;E<this.varying.length;E++){const O=this.varying[E];this.attributes[O].update(v[E+1],p.start,p.size)}},render(v){this.count&&(f.useProgram(this.program),f.bindVertexArray(this.vao),f.drawElementsInstanced(f.TRIANGLES,this.indices.count,f.UNSIGNED_SHORT,0,this.count))}};return m.vao=f.createVertexArray(),m.indices=rn(e,m.vao,new Uint16Array(c.indices)),m.attributes.vertex=ne(e,m,"vertex",3,new Float32Array(c.vertices)),m.attributes.uv=ne(e,m,"uv",2,new Float32Array(c.uvs)),m.attributes.normal=ne(e,m,"normal",3,new Float32Array(c.normals)),m.attributes.color=ne(e,m,"color",3,new Float32Array(i*3),1),l.forEach(v=>{m.attributes[v]=ne(e,m,v,s,new Float32Array(i*s),1)}),m.type=t,m.arity=s,m.instances=i,m.count=0,{[t]:m}},Ee=(e,t,n,o)=>{const{gl:a}=e;a.bindRenderbuffer(a.RENDERBUFFER,t),o?a.renderbufferStorageMultisample(a.RENDERBUFFER,o,n,a.drawingBufferWidth,a.drawingBufferHeight):a.renderbufferStorage(a.RENDERBUFFER,n,a.drawingBufferWidth,a.drawingBufferHeight),a.bindRenderbuffer(a.RENDERBUFFER,null)},Zn=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],a=[],i=[],s=[];let l=0;const f=[];for(let c=0;c<=n;c++){const u=[],m=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,E=[-e*Se(p*ye)*ce(m*G),e*Se(m*G),e*ce(p*ye)*ce(m*G)];a.push(...E);const O=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(N=>N*O)),s.push(p+h,1-m),u.push(l++)}f.push(u)}for(let c=0;c<n;c++)for(let u=0;u<t;u++){const m=f[c][u+1],h=f[c][u],v=f[c+1][u],p=f[c+1][u+1];c!==0&&o.push(m,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:a,normals:i,uvs:s,indices:o}},Qn=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:a=8,segments:i=1}={})=>{const s=[],l=[],f=[],c=[];e!==null&&(t=e,n=e);let u=0;const m=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const E=[],O=p/i,N=O*(n-t)+t;for(let A=0;A<=a;A++){const y=A/a,F=y*ye,U=ce(F),L=Se(F),ee=[N*U,-O*o+h,N*L];l.push(...ee);const P=[U,v,L],k=(P[0]**2+P[1]**2+P[2]**2)**-.5;f.push(...P.map(ae=>ae*k)),c.push(y,1-O),E.push(u++)}m.push(E)}for(let p=0;p<a;p++)for(let E=0;E<i;E++){const O=m[E][p],N=m[E+1][p],A=m[E+1][p+1],y=m[E][p+1];s.push(O,N,y),s.push(N,A,y)}return{vertices:l,normals:f,uvs:c,indices:s}},et=({segments:e=3}={})=>{const t=[],n=[],o=[],a=[],i=1/e;for(let s=0;s<e+1;s++)for(let l=0;l<s+1;l++)n.push((2*l-s)*i/2,s*i,0),o.push(0,0,1),a.push(i*l,1-i*s);for(let s=1;s<e+1;s++)for(let l=0;l<s;l++){const f=s*(s+1)/2+l,c=s*(s-1)/2+l;if(t.push(f,c,f+1),s<e){const u=(s+1)*(s+2)/2+l;t.push(u+1,f,f+1)}}return{vertices:n,normals:o,uvs:a,indices:t}},nt=`#include globals
#include fragment
`,tt=`#include globals
#include dimensions
