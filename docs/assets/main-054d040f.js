...
`)}),t),Ke=(e,t,n,o)=>{var m;const r=U[e.ambiance];let i="";const s=c=>c.toString().includes(".")?c:`${c}.`;Object.entries({shading:c=>Cn.indexOf(c),diffuse:c=>Fn.indexOf(c),specular:c=>Mn.indexOf(c),ambient:c=>s(c),shininess:c=>s(c),metalness:c=>s(c),roughness:c=>s(c),opacity:c=>s(c),gouraud:c=>"",envmap:c=>c?!0:null,texture:c=>c?!0:null,reversed:c=>c?!0:null,tesselation:c=>c==="full"?1:0}).forEach(([c,l])=>{const f=Object.keys(r).includes(o)&&Object.keys(r[o]).includes(c)?r[o][c]:r[c];if(f!==!1){let h=l(f);h===!0&&(h=""),h!==null&&(i+=`#define ${c.toUpperCase()} ${h}
