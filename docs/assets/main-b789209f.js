import{r as g,m as Re,a as ke,p as Xe,c as X,i as q,b as W,d as U,e as ye,T as je,s as le,P as G,t as qe,f as fn,g as pn,h as De,j as V,k as Ye,l as Ze,n as se,o as vn,q as hn,u as de,v as gn,w as xn,x as bn,y as En,z as wn,A as _e,B as Nn,C as Sn,D as a,E as me,F as Ie,G as Qe,H as yn,I as jn,N as B,J as fe,K as In,L as Tn,M as On,O as He}from"./CoxeterMatrix-a167633b.js";var An=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Rn(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}const Dn="xyzwvutsrqponmlkjihgfedcba",en=["perspective","stereographic","orthographic","klein","inverted","scale","joukowsky","half","upperhalf","halfsphere","band","cross","heart","teardrop","square","ring","sinusoidal","spiral","SC_Triangle","SC_Square","SC_Pentagon","SC_Hexagon"],Cn=["ads","normal","position","uv"],Fn=["lambert","oren-nayar","minnaert","cel","fresnel","reverse"],zn=["phong","blinn-phong","cook-torrance","ward-anisotropic"],Z=["lowest","lower","low","lowish","medium","highish","high","higher","ultra"],Te=["vertex","edge","face"],Pn=(e,t)=>{const n=g.useRef({previous:null,anteprevious:null,start:null,stable:!1});g.useEffect(()=>{const o=16.666666666666668;if(e.adaptative){let r=null,i=null,s=[];const l=20,m=10,c=u=>{if(i===null){n.current.start===null&&(n.current.start=u),i=u,r=requestAnimationFrame(c);return}if(s.push(u-i),i=u,s.length>Re(l,m)&&s.shift(),s.length>=m&&s.slice(-m).reduce((h,v)=>h+v,0)/m>(n.current.stable?2.01:1.51)*o){s=[],n.current.stable=!1;const h=Z.indexOf(e.detail);if(h>1){n.current.anteprevious=n.current.previous,n.current.previous=e.detail;const v=Z[h-1];t(p=>({...p,detail:v}))}}if(s.length>=l&&s.slice(-l).reduce((h,v)=>h+v,0)/l<(n.current.stable?1.001:1.01)*o){s=[],n.current.stable=!1;const h=Z.indexOf(e.detail);if(h<Z.length-2){const v=Z[h+1];v===n.current.previous&&e.detail===n.current.anteprevious&&u-n.current.start>1e3?n.current.stable=!0:(n.current.anteprevious=n.current.previous,n.current.previous=e.detail,t(p=>({...p,detail:v})))}}r=requestAnimationFrame(c)};return r=requestAnimationFrame(c),()=>cancelAnimationFrame(r)}},[e.detail,e.adaptative,e.ambiance,e.space,t]),g.useEffect(()=>{n.current={previous:null,anteprevious:null,stable:!1,start:null}},[e.space,e.shaper,e.ambiance])};class ge extends g.Component{constructor(t){super(t),this.state={error:!1}}static getDerivedStateFromError(t){return{error:!0}}static getDerivedStateFromProps(t){return{error:t.error}}componentDidCatch(t,n){this.props.onError(t,n)}render(){return this.state.error?null:this.props.children}}var nn={exports:{}};(function(e,t){(function(n,o){e.exports=o()})(An,function(){var n=function(){function o(v){return s.appendChild(v.dom),v}function r(v){for(var p=0;p<s.children.length;p++)s.children[p].style.display=p===v?"block":"none";i=v}var i=0,s=document.createElement("div");s.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",s.addEventListener("click",function(v){v.preventDefault(),r(++i%s.children.length)},!1);var l=(performance||Date).now(),m=l,c=0,u=o(new n.Panel("FPS","#0ff","#002")),f=o(new n.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=o(new n.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:s,addPanel:o,showPanel:r,begin:function(){l=(performance||Date).now()},end:function(){c++;var v=(performance||Date).now();if(f.update(v-l,200),v>m+1e3&&(u.update(1e3*c/(v-m),100),m=v,c=0,h)){var p=performance.memory;h.update(p.usedJSHeapSize/1048576,p.jsHeapSizeLimit/1048576)}return v},update:function(){l=this.end()},domElement:s,setMode:r}};return n.Panel=function(o,r,i){var s=1/0,l=0,m=Math.round,c=m(window.devicePixelRatio||1),u=80*c,f=48*c,h=3*c,v=2*c,p=3*c,E=15*c,R=74*c,S=30*c,D=document.createElement("canvas");D.width=u,D.height=f,D.style.cssText="width:80px;height:48px";var j=D.getContext("2d");return j.font="bold "+9*c+"px Helvetica,Arial,sans-serif",j.textBaseline="top",j.fillStyle=i,j.fillRect(0,0,u,f),j.fillStyle=r,j.fillText(o,h,v),j.fillRect(p,E,R,S),j.fillStyle=i,j.globalAlpha=.9,j.fillRect(p,E,R,S),{dom:D,update:function(F,H){s=Math.min(s,F),l=Math.max(l,F),j.fillStyle=i,j.globalAlpha=1,j.fillRect(0,0,u,E),j.fillStyle=r,j.fillText(m(F)+" "+o+" ("+m(s)+"-"+m(l)+")",h,v),j.drawImage(D,p+c,E,R-c,S,p,E,R-c,S),j.fillRect(p+R-c,E,c,S),j.fillStyle=i,j.globalAlpha=.9,j.fillRect(p+R-c,E,c,m((1-F/H)*S))}}},n})})(nn);var Mn=nn.exports;const Ln=Rn(Mn),kn=`const vec2 cone = vec2(1., 0);
...
`),Object.entries({...Wn,config:i}).forEach(([c,u])=>{t=t.replace(`#include ${c}`,u),n=n.replace(`#include ${c}`,u)}),[t,n].map(c=>qn(c,e.dimensions))},ce=(e,t,n,o,r)=>{if(e.gl.shaderSource(r,o),e.gl.compileShader(r),!e.gl.getShaderParameter(r,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(r);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},Be=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},tn=(e,t,n,o,r=[])=>{const{gl:i}=e,s=i.createProgram(),l=i.createShader(i.VERTEX_SHADER),m=i.createShader(i.FRAGMENT_SHADER);if(ce(e,t,"vertex",n,l)||ce(e,t,"fragment",o,m)||(i.attachShader(s,l),i.attachShader(s,m),Be(e,t,s)))return;const c={program:s,vertexShader:l,fragmentShader:m,uniformsDef:r,recompile(u,f,h,v=null){ce(u,t,"vertex",f,this.vertexShader)||ce(u,t,"fragment",h,this.fragmentShader)||Be(u,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(u))},bindUniforms(u){this.uniforms={},this.uniformsDef.forEach(({name:f,type:h,value:v})=>{this.uniforms[f]=Yn(u,this.program,f,h),this.uniforms[f].update(v)})}};return c.bindUniforms(e),c},te=(e,t,n,o,r,i=null,s=null)=>{const{gl:l}=e;s=s||l.FLOAT;const m=s===l.FLOAT?4:2,c={name:n,mesh:t,indices:an,instances:i,data:r,size:o,type:s,update(u=null,f=null,h=null){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer),u===null&&f===null&&h===null?l.bufferData(l.ARRAY_BUFFER,this.data,l.STATIC_DRAW):(this.data.set(u,f*this.size),l.bufferSubData(l.ARRAY_BUFFER,f*this.size*m,this.data,f*this.size,h*this.size))},extend(u,f,h=!1){if(l.bindVertexArray(this.mesh.vao),this.size=u,f&&(h&&f.length>=this.data.length&&f.set(this.data),this.data=f),this.location=l.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const v=u>4?3:1;for(let p=0;p<v;p++)l.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)l.vertexAttribPointer(this.location+p,u/v,this.type,!1,u*m,u/v*p*m);for(let p=0;p<v;p++)l.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const u=new Float32Array(this.data.length);return l.getBufferSubData(l.ARRAY_BUFFER,0,u),u}};return c.buffer=l.createBuffer(),c.extend(o),c},an=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const r=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,r),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:r,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},Yn=(e,t,n,o)=>{const{gl:r}=e;return{program:t,update(s){if(r.useProgram(this.program),o.startsWith("m")){const l=parseInt(o.slice(1,2));if(l>4)for(let m=0;m<l;m++){const c=r.getUniformLocation(t,`${n}.c${m+1}.v`);if(c!==null&&r.uniform4fv(c,s[m][0]),l-4===1){const u=r.getUniformLocation(t,`${n}.c${m+1}.u`);u!==null&&r.uniform1f(u,s[m][1])}else if(l-4>1){const u=r.getUniformLocation(t,`${n}.c${m+1}.u`);if(u!==null&&r[`uniform${U(l-4,4)}fv`](u,s[m][1]),l-8===1){const f=r.getUniformLocation(t,`${n}.c${m+1}.t`);f!==null&&r.uniform1f(f,s[m][2])}}}else{const m=r.getUniformLocation(t,n);m!==null&&r[`uniformMatrix${o.slice(1)}`](m,!1,s)}}else{const l=r.getUniformLocation(t,n);l!==null&&r[`uniform${o}`](l,s)}},get(){r.useProgram(this.program);const s=r.getUniformLocation(t,n);if(s!==null)return r.getUniform(this.program,s)}}},$=(e,t,n=null)=>{const{gl:o}=e,r=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,r,i),{texture:s,width:r,height:i}},ae=(e,t,n,o,r=[])=>{const i={name:t,vertex:n,fragment:o,...tn(e,t,n,o,r),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,r)}};return{[t]:i}},Ee=(e,t,n,o,r,i,s,l=["position"])=>{var h;const{gl:m}=e,c=r(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),u=v=>[{name:"viewProjection",type:"m4fv",value:X(q(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:X(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:X(q(v.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...W(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];s=s>4?9:s;const f={attributes:{},varying:l,vertex:n,type:t,fragment:o,...tn(e,t,...Ue(e,n,o,t),u(e)),recompileProgram(v){const[p,E]=Ue(v,this.vertex,this.fragment,this.type);this.recompile(v,p,E,u(v))},changeArity(v){v=v>4?9:v,this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,l.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=r(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillData(v,p){if(!p){this.count=0;return}this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v[0],p.start,p.size);for(let E=0;E<this.varying.length;E++){const R=this.varying[E];this.attributes[R].update(v[E+1],p.start,p.size)}},render(v){this.count&&(m.useProgram(this.program),m.bindVertexArray(this.vao),m.drawElementsInstanced(m.TRIANGLES,this.indices.count,m.UNSIGNED_SHORT,0,this.count))}};return f.vao=m.createVertexArray(),f.indices=an(e,f.vao,new Uint16Array(c.indices)),f.attributes.vertex=te(e,f,"vertex",3,new Float32Array(c.vertices)),f.attributes.uv=te(e,f,"uv",2,new Float32Array(c.uvs)),f.attributes.normal=te(e,f,"normal",3,new Float32Array(c.normals)),f.attributes.color=te(e,f,"color",3,new Float32Array(i*3),1),l.forEach(v=>{f.attributes[v]=te(e,f,v,s,new Float32Array(i*s),1)}),f.type=t,f.arity=s,f.instances=i,f.count=0,{[t]:f}},we=(e,t,n,o)=>{const{gl:r}=e;r.bindRenderbuffer(r.RENDERBUFFER,t),o?r.renderbufferStorageMultisample(r.RENDERBUFFER,o,n,r.drawingBufferWidth,r.drawingBufferHeight):r.renderbufferStorage(r.RENDERBUFFER,n,r.drawingBufferWidth,r.drawingBufferHeight),r.bindRenderbuffer(r.RENDERBUFFER,null)},Zn=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],r=[],i=[],s=[];let l=0;const m=[];for(let c=0;c<=n;c++){const u=[],f=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,E=[-e*ye(p*je)*le(f*G),e*ye(f*G),e*le(p*je)*le(f*G)];r.push(...E);const R=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(S=>S*R)),s.push(p+h,1-f),u.push(l++)}m.push(u)}for(let c=0;c<n;c++)for(let u=0;u<t;u++){const f=m[c][u+1],h=m[c][u],v=m[c+1][u],p=m[c+1][u+1];c!==0&&o.push(f,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:r,normals:i,uvs:s,indices:o}},Qn=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:r=8,segments:i=1}={})=>{const s=[],l=[],m=[],c=[];e!==null&&(t=e,n=e);let u=0;const f=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const E=[],R=p/i,S=R*(n-t)+t;for(let D=0;D<=r;D++){const j=D/r,F=j*je,H=le(F),L=ye(F),ne=[S*H,-R*o+h,S*L];l.push(...ne);const P=[H,v,L],k=(P[0]**2+P[1]**2+P[2]**2)**-.5;m.push(...P.map(he=>he*k)),c.push(j,1-R),E.push(u++)}f.push(E)}for(let p=0;p<r;p++)for(let E=0;E<i;E++){const R=f[E][p],S=f[E+1][p],D=f[E+1][p+1],j=f[E][p+1];s.push(R,S,j),s.push(S,D,j)}return{vertices:l,normals:m,uvs:c,indices:s}},et=({segments:e=3}={})=>{const t=[],n=[],o=[],r=[],i=1/e;for(let s=0;s<e+1;s++)for(let l=0;l<s+1;l++)n.push((2*l-s)*i/2,s*i,0),o.push(0,0,1),r.push(i*l,1-i*s);for(let s=1;s<e+1;s++)for(let l=0;l<s;l++){const m=s*(s+1)/2+l,c=s*(s-1)/2+l;if(t.push(m,c,m+1),s<e){const u=(s+1)*(s+2)/2+l;t.push(u+1,m,m+1)}}return{vertices:n,normals:o,uvs:r,indices:t}},nt=`#include globals
#include fragment
`,tt=`#include globals
#include dimensions
