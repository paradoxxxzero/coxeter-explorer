import{r as g,m as Te,a as Fe,p as Ve,c as X,i as q,b as W,d as H,e as we,T as Se,s as ce,P as G,t as Ge,f as cn,g as ln,h as Oe,j as V,k as Je,l as Ke,n as oe,o as un,q as fn,u as dn,v as mn,w as pn,x as vn,y as hn,z as ze,A as gn,B as xn,C as r,D as ue,E as ye,F as We,G as bn,H as En,N as B,I as fe,J as Nn,K as wn,L as Sn,M as yn,O as Pe}from"./CoxeterMatrix-c47fe48b.js";var jn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function In(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}const Tn="xyzwvutsrqponmlkjihgfedcba",Xe=["perspective","stereographic","orthographic","klein","inverted","scale","joukowsky","half","upperhalf","halfsphere","band","cross","heart","teardrop","square","ring","sinusoidal","spiral","SC_Triangle","SC_Square","SC_Pentagon","SC_Hexagon"],On=["ads","normal","position","uv"],An=["lambert","oren-nayar","minnaert","cel","fresnel","reverse"],Rn=["phong","blinn-phong","cook-torrance","ward-anisotropic"],Y=["lowest","lower","low","lowish","medium","highish","high","higher","ultra"],je=["vertex","edge","face"],Dn=(e,t)=>{const n=g.useRef({previous:null,anteprevious:null,start:null,stable:!1});g.useEffect(()=>{const s=16.666666666666668;if(e.adaptative){let a=null,i=null,o=[];const l=20,d=10,c=u=>{if(i===null){n.current.start===null&&(n.current.start=u),i=u,a=requestAnimationFrame(c);return}if(o.push(u-i),i=u,o.length>Te(l,d)&&o.shift(),o.length>=d&&o.slice(-d).reduce((h,v)=>h+v,0)/d>(n.current.stable?2.01:1.51)*s){o=[],n.current.stable=!1;const h=Y.indexOf(e.detail);if(h>1){n.current.anteprevious=n.current.previous,n.current.previous=e.detail;const v=Y[h-1];t(p=>({...p,detail:v}))}}if(o.length>=l&&o.slice(-l).reduce((h,v)=>h+v,0)/l<(n.current.stable?1.001:1.01)*s){o=[],n.current.stable=!1;const h=Y.indexOf(e.detail);if(h<Y.length-2){const v=Y[h+1];v===n.current.previous&&e.detail===n.current.anteprevious&&u-n.current.start>1e3?n.current.stable=!0:(n.current.anteprevious=n.current.previous,n.current.previous=e.detail,t(p=>({...p,detail:v})))}}a=requestAnimationFrame(c)};return a=requestAnimationFrame(c),()=>cancelAnimationFrame(a)}},[e.detail,e.adaptative,e.ambiance,e.space,t]),g.useEffect(()=>{n.current={previous:null,anteprevious:null,stable:!1,start:null}},[e.space,e.shaper,e.ambiance])};class ve extends g.Component{constructor(t){super(t),this.state={error:!1}}static getDerivedStateFromError(t){return{error:!0}}static getDerivedStateFromProps(t){return{error:t.error}}componentDidCatch(t,n){this.props.onError(t,n)}render(){return this.state.error?null:this.props.children}}var qe={exports:{}};(function(e,t){(function(n,s){e.exports=s()})(jn,function(){var n=function(){function s(v){return o.appendChild(v.dom),v}function a(v){for(var p=0;p<o.children.length;p++)o.children[p].style.display=p===v?"block":"none";i=v}var i=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(v){v.preventDefault(),a(++i%o.children.length)},!1);var l=(performance||Date).now(),d=l,c=0,u=s(new n.Panel("FPS","#0ff","#002")),m=s(new n.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=s(new n.Panel("MB","#f08","#201"));return a(0),{REVISION:16,dom:o,addPanel:s,showPanel:a,begin:function(){l=(performance||Date).now()},end:function(){c++;var v=(performance||Date).now();if(m.update(v-l,200),v>d+1e3&&(u.update(1e3*c/(v-d),100),d=v,c=0,h)){var p=performance.memory;h.update(p.usedJSHeapSize/1048576,p.jsHeapSizeLimit/1048576)}return v},update:function(){l=this.end()},domElement:o,setMode:a}};return n.Panel=function(s,a,i){var o=1/0,l=0,d=Math.round,c=d(window.devicePixelRatio||1),u=80*c,m=48*c,h=3*c,v=2*c,p=3*c,E=15*c,O=74*c,w=30*c,R=document.createElement("canvas");R.width=u,R.height=m,R.style.cssText="width:80px;height:48px";var S=R.getContext("2d");return S.font="bold "+9*c+"px Helvetica,Arial,sans-serif",S.textBaseline="top",S.fillStyle=i,S.fillRect(0,0,u,m),S.fillStyle=a,S.fillText(s,h,v),S.fillRect(p,E,O,w),S.fillStyle=i,S.globalAlpha=.9,S.fillRect(p,E,O,w),{dom:R,update:function(F,U){o=Math.min(o,F),l=Math.max(l,F),S.fillStyle=i,S.globalAlpha=1,S.fillRect(0,0,u,E),S.fillStyle=a,S.fillText(d(F)+" "+s+" ("+d(o)+"-"+d(l)+")",h,v),S.drawImage(R,p+c,E,O-c,w,p,E,O-c,w),S.fillRect(p+O-c,E,c,w),S.fillStyle=i,S.globalAlpha=.9,S.fillRect(p+O-c,E,c,d((1-F/U)*w))}}},n})})(qe);var Cn=qe.exports;const Fn=In(Cn),zn=`const vec2 cone = vec2(1., 0);
...
#endif
`,he=(e,t,n)=>(n<0&&(n+=1),n>1&&(n-=1),n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e),z=(e,t,n)=>{let s,a,i;if(t===0)s=a=i=n;else{const o=n<.5?n*(1+t):n+t-n*t,l=2*n-o;s=he(l,o,e+1/3),a=he(l,o,e),i=he(l,o,e-1/3)}return[s,a,i]},se=[[10/360,.56,.91],[0/360,.59,.88],[316/360,.72,.86],[267/360,.84,.81],[343/360,.81,.75],[350/360,.65,.77],[23/360,.92,.75],[41/360,.86,.83],[115/360,.54,.76],[170/360,.57,.73],[189/360,.71,.73],[199/360,.76,.69],[217/360,.92,.76],[232/360,.97,.85]],$n={background:[0,0,0,1],glow:!1,shading:"ads",diffuse:"lambert",specular:!1,shininess:32,opacity:1,ambient:.2,roughness:.85,gouraud:!1,transparency:"oit",color:({word:e})=>z(e.length*.03%1,.75,.7)},Q=Object.fromEntries(Object.entries({neon:{background:[0,0,0,1],glow:{exposure:1.75,strength:2,offset:{up:2,down:2},steps:3,pow:2},shading:!1,face:{opacity:.025},transparency:"blend",color:({word:e,dual:t})=>z((e.length*.17-(t?.43:0))%1,.5,.6)},disco:{background:[0,0,0,1],glow:{exposure:1.5,strength:2,offset:{up:2,down:2},steps:4,pow:2},face:{gouraud:!0,diffuse:"fresnel",opacity:.025},transparency:"blend",color:({word:e})=>z(...se[e.length%se.length])},cathedral:{background:[.6,.6,.6,1],glow:{exposure:1.5,strength:2,offset:{up:2,down:2},steps:4,pow:2},shading:!1,face:{opacity:.9},transparency:"oit",color:({word:e,subShape:t,type:n})=>n==="face"?z((t*.23+e.length*.07)%1,1,.58):[0,0,0]},synthwave:{background:[...z(.77,.6,.04),1],glow:{exposure:1.5,strength:3,offset:{up:3,down:3},steps:3,pow:2},shading:!1,face:{opacity:.015},afterImage:.7,transparency:"blend",color:({word:e})=>z((.5-e.length*.05%.5+.65)%1,.4,.6)},colorful:{background:[1,1,1,1],diffuse:"oren-nayar",specular:"cook-torrance",shininess:32,opacity:1,ambient:.2,gouraud:!1,face:{gouraud:!0,opacity:.1,diffuse:"fresnel",specular:!1},transparency:"oit",color:({word:e,dual:t})=>z(e.length*.03%1-(t?.25:0),1,.8)},shiny:{background:[0,0,0,1],diffuse:"lambert",specular:"blinn-phong",shininess:32,opacity:1,ambient:.2,gouraud:!1,face:{gouraud:!0,opacity:.1,diffuse:"fresnel",specular:!1},transparency:"oit",color:({word:e})=>z(-(e.length*.07)%1,1,.8)},shape:{background:[1,1,1,1],transparency:"oit",face:{gouraud:!0,opacity:.2,diffuse:"fresnel"},color:({faceSize:e,type:t,idx:n,size:s})=>t==="face"?z((e-2)*.21%1,1,.8):z(n/s,.75,.5)},subShape:{background:[1,1,1,1],transparency:"oit",face:{gouraud:!0,opacity:.2,diffuse:"fresnel"},color:({subShape:e,type:t})=>t!=="vertex"?z(e*.21%1,1,.8):[1,1,1]},reflection:{background:[1,1,1,1],diffuse:"cel",face:{opacity:.6,gouraud:!1},transparency:"blend",color:({word:e,type:t,dimensions:n,draw:s})=>{const a=e.length?Fe(e[e.length-1])/n:0;return z(a%1,1,t==="face"?.6:s.face?0:.8)}},harlequin:{background:[...z(240/360,.23,.09),1],face:{opacity:.6},transparency:"oit",color:({word:e,idx:t,type:n})=>{const s=e.split("").map(i=>Fe(i)).reduce((i,o)=>i+o,0),a=[...se[s%se.length]];return t%2&&(a[2]*=.5),z(...a)}},pure:{background:[0,0,0,1],color:({word:e})=>z(e.length*.03%1,.75,.7)},facets:{background:[0,0,0,1],color:({faceIndex:e,faceSize:t})=>z((e||0)/(t||1),.75,.7)},monochrome:{background:[.12,.12,.12,1],diffuse:"reverse",ambient:0,face:{opacity:.1},transparency:"oit",color:()=>[1,1,1]},glass:{background:[0,0,0,1],transparency:"blend",opacity:.2,ambient:0,diffuse:"fresnel",specular:"blinn-phong",face:{shininess:16,diffuse:!1},color:({subShape:e,word:t,type:n})=>n!=="vertex"?z((e*.21+t.length*.03)%1,1,.8):[1,1,1]},plain:{extended:!0,background:[1,1,1,1],glow:!1,shading:!1,color:({word:e,type:t,draw:n})=>z(e.length*.06%1,1,t==="face"?.6:n.face?.05:.5)},plainblack:{extended:!0,background:[1,1,1,1],shading:!1,color:({word:e,type:t})=>t==="face"?new Array(3).fill(1-Ve(.9,e.length+1)):[0,0,0]},normals:{extended:!0,background:[1,1,1,1],shading:"normal",color:()=>[0,0,0]},uvs:{extended:!0,background:[1,1,1,1],shading:"uv",color:()=>[0,0,0]}}).map(([e,t])=>[e,{...$n,...t,transparent:{}}])),Vn={globals:Mn,dimensions:Pn,project:_n,helpers:Ln,complex:zn,fragment:Un,vertexouthead:Bn,lighting:kn,vertexout:Hn},Gn=(e,t,n)=>{t=n?1:t||1,t=Math.max(0,t);const s=n?n.width:e.clientWidth*t|0,a=n?n.height:e.clientHeight*t|0;return e.width!==s||e.height!==a?(e.width=s,e.height=a,!0):!!n},ge=(e,t)=>e.replace(/\bvecN\b/g,`vec${t}`).replace(/\bmatN\b/g,`mat${t}`).replace(/\bfovN\b/g,`fov${t}`).replace(/\bvecN_1\b/g,`vec${t-1}`).replace(/\bvec1\b/g,"float").replace(/\b_N_\b/g,`${t}`).replace(/\b_Nf_\b/g,`${t}.`).replace(/\PROJECTION_N\b/g,`PROJECTION${t}`),Jn=(e,t)=>ge(e.replace(/#loopN(\d)(.+?)#endloopN/gs,(n,s,a)=>{const i=[];for(let o=s;o<=t;o++)i.push(ge(a.replace(/#ifN(\d)(.+?)(#elseN(.+?)):?#endifN/gs,(l,d,c,u,m)=>d===`${o}`?ge(c,o):m||""),o));return i.join(`
`)}),t),Me=(e,t,n,s)=>{var d;const a=Q[e.ambiance];let i="";const o=c=>c.toString().includes(".")?c:`${c}.`;Object.entries({shading:c=>On.indexOf(c),diffuse:c=>An.indexOf(c),specular:c=>Rn.indexOf(c),ambient:c=>o(c),shininess:c=>o(c),roughness:c=>o(c),opacity:c=>o(c),gouraud:c=>""}).forEach(([c,u])=>{const m=Object.keys(a).includes(s)&&Object.keys(a[s]).includes(c)?a[s][c]:a[c];m!==!1&&(i+=`#define ${c.toUpperCase()} ${u(m)}
`),c==="opacity"&&m<1&&(a.transparent[s]=!0,i+=`#define TRANSPARENT
`,a.transparency==="oit"&&(i+=`#define OIT
`))}),i+=`#define DIMENSIONS ${e.dimensions}
`;for(let c=3;c<=e.dimensions;c++)i+=`#define PROJECTION${c} ${Xe.indexOf(e[`projection${c}`])-1}
`;return i+=`#define CURVATURE ${((d=e.space)==null?void 0:d.curvature)||0}
`,e.curve&&(i+=`#define SEGMENTS
`),Object.entries({...Vn,config:i}).forEach(([c,u])=>{t=t.replace(`#include ${c}`,u),n=n.replace(`#include ${c}`,u)}),[t,n].map(c=>Jn(c,e.dimensions))},ie=(e,t,n,s,a)=>{if(e.gl.shaderSource(a,s),e.gl.compileShader(a),!e.gl.getShaderParameter(a,e.gl.COMPILE_STATUS)){const o=e.gl.getShaderInfoLog(a);return console.error(`An error occurred compiling the ${t}->${n} shader: ${o}`,{shaderSource:s}),o}},Le=(e,t,n)=>{const{gl:s}=e;if(s.linkProgram(n),!s.getProgramParameter(n,s.LINK_STATUS)){const i=s.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},Ye=(e,t,n,s,a=[])=>{const{gl:i}=e,o=i.createProgram(),l=i.createShader(i.VERTEX_SHADER),d=i.createShader(i.FRAGMENT_SHADER);if(ie(e,t,"vertex",n,l)||ie(e,t,"fragment",s,d)||(i.attachShader(o,l),i.attachShader(o,d),Le(e,t,o)))return;const c={program:o,vertexShader:l,fragmentShader:d,uniformsDef:a,recompile(u,m,h,v=null){ie(u,t,"vertex",m,this.vertexShader)||ie(u,t,"fragment",h,this.fragmentShader)||Le(u,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(u))},bindUniforms(u){this.uniforms={},this.uniformsDef.forEach(({name:m,type:h,value:v})=>{this.uniforms[m]=Kn(u,this.program,m,h),this.uniforms[m].update(v)})}};return c.bindUniforms(e),c},ne=(e,t,n,s,a,i=null,o=null)=>{const{gl:l}=e;o=o||l.FLOAT;const d=o===l.FLOAT?4:2,c={name:n,mesh:t,indices:Ze,instances:i,data:a,size:s,type:o,update(u=null,m=null,h=null){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer),u===null&&m===null&&h===null?l.bufferData(l.ARRAY_BUFFER,this.data,l.STATIC_DRAW):(this.data.set(u,m*this.size),l.bufferSubData(l.ARRAY_BUFFER,m*this.size*d,this.data,m*this.size,h*this.size))},extend(u,m,h=!1){if(l.bindVertexArray(this.mesh.vao),this.size=u,m&&(h&&m.length>=this.data.length&&m.set(this.data),this.data=m),this.location=l.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const v=u>4?3:1;for(let p=0;p<v;p++)l.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)l.vertexAttribPointer(this.location+p,u/v,this.type,!1,u*d,u/v*p*d);for(let p=0;p<v;p++)l.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const u=new Float32Array(this.data.length);return l.getBufferSubData(l.ARRAY_BUFFER,0,u),u}};return c.buffer=l.createBuffer(),c.extend(s),c},Ze=(e,t,n)=>{const{gl:s}=e;s.bindVertexArray(t);const a=s.createBuffer();return s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,a),s.bufferData(s.ELEMENT_ARRAY_BUFFER,n,s.STATIC_DRAW),{buffer:a,vao:t,indices:n,count:n.length,update(i){s.bindVertexArray(this.vao),this.indices=i,this.count=i.length,s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,this.buffer),s.bufferData(s.ELEMENT_ARRAY_BUFFER,i,s.STATIC_DRAW)}}},Kn=(e,t,n,s)=>{const{gl:a}=e;return{program:t,update(o){if(a.useProgram(this.program),s.startsWith("m")){const l=parseInt(s.slice(1,2));if(l>4)for(let d=0;d<l;d++){const c=a.getUniformLocation(t,`${n}.c${d+1}.v`);if(c!==null&&a.uniform4fv(c,o[d][0]),l-4===1){const u=a.getUniformLocation(t,`${n}.c${d+1}.u`);u!==null&&a.uniform1f(u,o[d][1])}else if(l-4>1){const u=a.getUniformLocation(t,`${n}.c${d+1}.u`);if(u!==null&&a[`uniform${H(l-4,4)}fv`](u,o[d][1]),l-8===1){const m=a.getUniformLocation(t,`${n}.c${d+1}.t`);m!==null&&a.uniform1f(m,o[d][2])}}}else{const d=a.getUniformLocation(t,n);d!==null&&a[`uniformMatrix${s.slice(1)}`](d,!1,o)}}else{const l=a.getUniformLocation(t,n);l!==null&&a[`uniform${s}`](l,o)}},get(){a.useProgram(this.program);const o=a.getUniformLocation(t,n);if(o!==null)return a.getUniform(this.program,o)}}},$=(e,t,n=null)=>{const{gl:s}=e,a=n?~~(n*s.drawingBufferWidth):s.drawingBufferWidth,i=n?~~(n*s.drawingBufferHeight):s.drawingBufferHeight,o=s.createTexture();return s.bindTexture(s.TEXTURE_2D,o),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE),s.texStorage2D(s.TEXTURE_2D,1,t,a,i),{texture:o,width:a,height:i}},te=(e,t,n,s,a=[])=>{const i={name:t,vertex:n,fragment:s,...Ye(e,t,n,s,a),recompileProgram(o){this.recompile(o,this.vertex,this.fragment,a)}};return{[t]:i}},xe=(e,t,n,s,a,i,o,l=["position"])=>{var h;const{gl:d}=e,c=a(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),u=v=>[{name:"viewProjection",type:"m4fv",value:X(q(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:X(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:X(q(v.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...W(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];o=o>4?9:o;const m={attributes:{},varying:l,vertex:n,type:t,fragment:s,...Ye(e,t,...Me(e,n,s,t),u(e)),recompileProgram(v){const[p,E]=Me(v,this.vertex,this.fragment,this.type);this.recompile(v,p,E,u(v))},changeArity(v){v=v>4?9:v,this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,l.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=a(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillData(v,p){if(!p){this.count=0;return}this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v[0],p.start,p.size);for(let E=0;E<this.varying.length;E++){const O=this.varying[E];this.attributes[O].update(v[E+1],p.start,p.size)}},render(v){this.count&&(d.useProgram(this.program),d.bindVertexArray(this.vao),d.drawElementsInstanced(d.TRIANGLES,this.indices.count,d.UNSIGNED_SHORT,0,this.count))}};return m.vao=d.createVertexArray(),m.indices=Ze(e,m.vao,new Uint16Array(c.indices)),m.attributes.vertex=ne(e,m,"vertex",3,new Float32Array(c.vertices)),m.attributes.uv=ne(e,m,"uv",2,new Float32Array(c.uvs)),m.attributes.normal=ne(e,m,"normal",3,new Float32Array(c.normals)),m.attributes.color=ne(e,m,"color",3,new Float32Array(i*3),1),l.forEach(v=>{m.attributes[v]=ne(e,m,v,o,new Float32Array(i*o),1)}),m.type=t,m.arity=o,m.instances=i,m.count=0,{[t]:m}},be=(e,t,n,s)=>{const{gl:a}=e;a.bindRenderbuffer(a.RENDERBUFFER,t),s?a.renderbufferStorageMultisample(a.RENDERBUFFER,s,n,a.drawingBufferWidth,a.drawingBufferHeight):a.renderbufferStorage(a.RENDERBUFFER,n,a.drawingBufferWidth,a.drawingBufferHeight),a.bindRenderbuffer(a.RENDERBUFFER,null)},Wn=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const s=[],a=[],i=[],o=[];let l=0;const d=[];for(let c=0;c<=n;c++){const u=[],m=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,E=[-e*we(p*Se)*ce(m*G),e*we(m*G),e*ce(p*Se)*ce(m*G)];a.push(...E);const O=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(w=>w*O)),o.push(p+h,1-m),u.push(l++)}d.push(u)}for(let c=0;c<n;c++)for(let u=0;u<t;u++){const m=d[c][u+1],h=d[c][u],v=d[c+1][u],p=d[c+1][u+1];c!==0&&s.push(m,h,p),c!==n-1&&s.push(h,v,p)}return{vertices:a,normals:i,uvs:o,indices:s}},Xn=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:s=1,radialSegments:a=8,segments:i=1}={})=>{const o=[],l=[],d=[],c=[];e!==null&&(t=e,n=e);let u=0;const m=[],h=s/2,v=(n-t)/s;for(let p=0;p<=i;p++){const E=[],O=p/i,w=O*(n-t)+t;for(let R=0;R<=a;R++){const S=R/a,F=S*Se,U=ce(F),k=we(F),ee=[w*U,-O*s+h,w*k];l.push(...ee);const P=[U,v,k],L=(P[0]**2+P[1]**2+P[2]**2)**-.5;d.push(...P.map(ae=>ae*L)),c.push(S,1-O),E.push(u++)}m.push(E)}for(let p=0;p<a;p++)for(let E=0;E<i;E++){const O=m[E][p],w=m[E+1][p],R=m[E+1][p+1],S=m[E][p+1];o.push(O,w,S),o.push(w,R,S)}return{vertices:l,normals:d,uvs:c,indices:o}},qn=({segments:e=3}={})=>{const t=[],n=[],s=[],a=[],i=1/e;for(let o=0;o<e+1;o++)for(let l=0;l<o+1;l++)n.push((2*l-o)*i/2,o*i,0),s.push(0,0,1),a.push(i*l,1-i*o);for(let o=1;o<e+1;o++)for(let l=0;l<o;l++){const d=o*(o+1)/2+l,c=o*(o-1)/2+l;if(t.push(d,c,d+1),o<e){const u=(o+1)*(o+2)/2+l;t.push(u+1,d,d+1)}}return{vertices:n,normals:s,uvs:a,indices:t}},Yn=`#include globals
#include fragment
`,Zn=`#include globals
#include dimensions
...
`,Ee={vertex:(e,t)=>Wn({lowest:{widthSegments:6,segments:2},lower:{widthSegments:8,segments:4},low:{widthSegments:8,segments:8},lowish:{widthSegments:12,segments:8},medium:{widthSegments:16,segments:16},highish:{widthSegments:32,segments:16},high:{widthSegments:32,segments:32},higher:{widthSegments:64,segments:32},ultra:{widthSegments:128,segments:64}}[t||"medium"]),edge:(e,t)=>Xn({lowest:{segments:e?4:1,radialSegments:4},lower:{segments:e?8:1,radialSegments:5},low:{segments:e?12:1,radialSegments:6},lowish:{segments:e?14:1,radialSegments:7},medium:{segments:e?16:1,radialSegments:8},highish:{segments:e?24:1,radialSegments:10},high:{segments:e?32:1,radialSegments:12},higher:{segments:e?64:1,radialSegments:16},ultra:{segments:e?128:1,radialSegments:32}}[t||"medium"]),face:(e,t)=>qn({lowest:{segments:e?4:1},lower:{segments:e?8:1},low:{segments:e?12:1},lowish:{segments:e?14:1},medium:{segments:e?16:1},highish:{segments:e?24:1},high:{segments:e?32:1},higher:{segments:e?64:1},ultra:{segments:e?128:1}}[t||"medium"])};function rt(e){return{meshes:je,...xe(e,"vertex",tt,nt,Ee.vertex,1024,e.dimensions),...xe(e,"edge",Zn,Yn,Ee.edge,1024,e.dimensions,["position","target"]),...xe(e,"face",et,Qn,Ee.face,1024,e.dimensions,["position","target","center"]),reset(){for(let t=0;t<this.meshes.length;t++)this[this.meshes[t]].count=0},changeArity(t){for(let n=0;n<this.meshes.length;n++)this[this.meshes[n]].changeArity(t)},updateGeometries(t){for(let n=0;n<this.meshes.length;n++)this[this.meshes[n]].updateGeometry(t)},recompilePrograms(t){for(let n=0;n<this.meshes.length;n++)this[this.meshes[n]].recompileProgram(t)},updateUniforms(t,n=!1,s=null){for(let a=0;a<this.meshes.length;a++){const i=this.meshes[a],o=this[i];if(!n){o.uniforms.metric.update(X(t.space.metric)),o.uniforms.matrix.update(X(t.matrix));for(let l=4;l<=t.dimensions;l++)o.uniforms[`fov${l}`].update(1/Ge(G*t[`fov${l}`]*.5/180));i==="vertex"?o.uniforms.thickness.update(t.sizeVertex):i==="edge"&&o.uniforms.thickness.update(t.sizeEdge)}o.uniforms.viewProjection.update(t.camera.viewProjection),o.uniforms.zoom.update(n?s:t.zoom),o.uniforms.eye.update(t.camera.eye)}},fillData(t){for(let n=0;n<this.meshes.length;n++){const s=this.meshes[n];this[s].fillData(t.data[n],t.infos[n])}}}}const at=`#version 300 es
precision highp float;
