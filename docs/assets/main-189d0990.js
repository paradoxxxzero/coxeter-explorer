import{c as he,a as dn,s as mn,m as ye,d as Ve,b as le,e as D,f as B,g as vn,h as pn,i as ue,P as H,j as qe,k as hn,l as gn,n as k,o as Ge,p as V,t as Ce,q,r as xn,u as re,v as bn,w as g,x as $e,y as ze,z as Je,A as K,T as Ie,B as Ke,C as En,D as We,E as oe,F as Nn,G as wn,H as r,I as fe,J as je,K as Xe,L as Sn,N as Q,M as de,O as yn}from"./CoxeterDiagram-482beb5d.js";var In=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function jn(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}const On="xyzwvutsrqponmlkjihgfedcba",Ye=["perspective","stereographic","orthographic","klein","inverted","scale","joukowsky","half","upperhalf","halfsphere","band","cross","heart","teardrop","square","ring","sinusoidal","spiral","SC_Triangle","SC_Square","SC_Pentagon","SC_Hexagon"],Ze=["linear","sine","quadratic","cubic","quartic","quintic","exponential","circular","back","elastic","bounce","inverse_sine","inverse_quadratic","inverse_cubic","inverse_quartic","inverse_quintic"],An=["ads","normal","position","uv"],Tn=["lambert","oren-nayar","minnaert","cel","fresnel","reverse"],Rn=["phong","blinn-phong","cook-torrance","ward-anisotropic"],W=["lowest","lower","low","lowish","medium","highish","high","higher","ultra"],Oe=["vertex","edge","face"],Fn=(e,t)=>{let n;return(...s)=>(clearTimeout(n),n=setTimeout(()=>e(...s),t),()=>clearTimeout(n))},P=(e,t=null,n=1,s=!1)=>{if(t===null&&(t=e,e=0),n===0)throw new Error("Step cannot be zero.");if(t<e&&n>0||t>e&&n<0){if(s)return[];n=-n}return new Array(Math.ceil((t-e)/n)).fill().map((a,o)=>e+o*n)},Ae=(e,t)=>e.length!==t.length?!1:e.every((n,s)=>Array.isArray(n)?Ae(n,t[s]):n===t[s]),Dn=(e,t,n)=>mn(e,ye(le(_n(n),t),2*Ve(le(Re(n),e),t))),Cn=(e,t,n=-1)=>t.some((s,a)=>s.some((o,i)=>a===i&&o===0))?ye(e,1/e[e.length-1]):ye(e,n/D(B(Ve(le(t,e),e)))),zn=(e,t)=>vn(e.map((n,s)=>n.map((a,o)=>a<0?-pn(-a/10):a===0?-1:-ue(t[s][o]*H/a)))),Qe=e=>{const t=xn(e);return{"+":t.values.filter(n=>n>0).length,"-":t.values.filter(n=>n<0).length,0:t.values.filter(n=>n===0).length,eigens:t}},en=(e,t=[],n=0,s=10)=>{t[n]=t[n]||[];for(let a=0;a<e.length;a++){const o=e.filter((i,c)=>c!==a).map(i=>i.filter((c,f)=>f!==a));t[n].push(Qe(o)),o.length>1&&n+1<s&&en(o,t,n+1,s)}return t},Mn=e=>{const t=Qe(e),n=t.eigens,s=qe(n.values.map(c=>hn(c))),a={eigens:n,gram:e,metric:s};if(t["-"]===0&&t[0]===0)return{...a,type:"finite",curvature:1};if(t["-"]===0&&t[0]>0)return{...a,type:"affine",curvature:0};if(t["-"]>1)return{...a,type:"hyperbolic",subtype:"superhyperbolic",level:t["-"],curvature:-1};const o=en(e,[],0,3),i=o[0];if(i.every(c=>c["-"]===0&&c[0]===0))return{...a,type:"hyperbolic",subtype:"compact",curvature:-1};if(i.every(c=>c["-"]===0))return{...a,type:"hyperbolic",subtype:"paracompact",curvature:-1};for(let c=1;c<o.length;c++)if(o[c].every(l=>l["-"]===0))return{...a,type:"hyperbolic",subtype:"lorentzian",curvature:-1,level:c+1};return console.info("indefinite",o),{...a,type:"indefinite",curvature:-1}},Te=1,Re=e=>e.map((t,n)=>t.map((s,a)=>n===a&&s===0?Te:s)),_n=e=>e.map(t=>t.map(n=>B(n))),Pn=(e,t)=>{const n=e.eigens,s=e.metric;if(t){const{L:v,D:b}=gn(e.gram);let I;if(b.some((N,j)=>isNaN(b[j][j])))console.warn("Can’t cholesky"),I=Un(e,t);else{const N=k(s,b).map((j,S)=>j.map((R,M)=>S===M?D(R):0));s.forEach((j,S)=>{j[S]===0&&(N[S][S]=Te)}),I=k(v,N)}if(I){const N=k(I,Re(s)),j=Ge(N);if(!j.some(S=>S.some(R=>isNaN(R))))return{normals:I,vertices:j}}console.warn("Can’t center")}const a=n.values.slice(),o=n.vectors.slice(),i=V(...a.filter(v=>v>0)),c=a.indexOf(i);[s[c][c],s[1][1]]=[s[1][1],s[c][c]],o.splice(1,0,o.splice(c,1)[0]),a.splice(c,1),a.splice(1,0,i),a.forEach((v,b)=>{v===0&&(a[b]=.05)});const f=Ce(o),l=qe(a),u=k(s,l).map((v,b)=>v.map((I,N)=>b===N?D(I):0));s.forEach((v,b)=>{v[b]===0&&(u[b][b]=Te)});const d=u.map((v,b)=>v.map((I,N)=>b===N?I!==0?1/I:1:0)),m=k(f,u),p=k(k(Re(s),d),Ce(f));return{normals:m,vertices:p}},Ln=e=>e.sort((t,n)=>{const[s,a]=t,[o,i]=n;return s===0&&a===1?1:o===0&&i===1||s<2&&o>=2?-1:o<2&&s>=2?1:s<2&&o<2?a===i?o-s:a-i:s===o?i-a:o-s}),kn=(e,t)=>{const n=Ln(he(P(e),2));if(t.metric.filter((s,a)=>t.metric[a][a]<0).length===1){const s=[...he(P(e-1),2),...he(P(e-1),2).map(([a,o])=>[o,a])].sort((a,o)=>a[0]-o[0]||(a[0]<a[1]?a[1]-o[1]:o[1]-a[1])).map(([a,o])=>[-a,-o]);if(n.length%2){const a=n.pop();n.push(...s,a)}else n.push(...s)}return{combinations:n,maxShift:~~dn(n.length/2)}},nn=(e,[t,n],s,a)=>{const o=q(s);if(t<0||n<0){const u=-t;t=-n,n=P(s).find(m=>a[m][m]<0);const d=.5*e*e;return o[u][u]=1-d,o[n][n]=1+d,o[u][t]=e,o[t][u]=-e,o[t][n]=e,o[n][t]=e,o[u][n]=d,o[n][u]=-d,o}if(a[t][t]*a[n][n]===0)return a[t][t]===0&&(o[n][t]=e),a[n][n]===0&&(o[t][n]=e),o;const i=a[t][t]*a[n][n],f=(i>0?re:bn)(e),l=D(1-i*f*f);return o[t][t]=l,o[n][n]=l,o[t][n]=-i*f,o[n][t]=f,o},Un=(e,t)=>{const n=e.gram,s=n.length,a=e.curvature;let o=null;const i=n.every((c,f)=>c.every((l,u)=>f===u||l<=-1));if(t||i){if(o=new Array(s).fill(0).map(()=>new Array(s).fill(0)),s===2){const c=(n[0][1]+1)/2;return o[0][0]=D(c-n[0][1]),o[1][0]=-D(c-n[0][1]),o[0][1]=o[1][1]=D((a||1)*c),a===0&&(o[1][1]=.5),o}else if(s===3){const c=n[0][1],f=n[1][2],l=n[0][2],u=(c*c+f*f+l*l-2*c*f*l-1)/(c*c+f*f+l*l-2*c*f-2*c*l-2*f*l+2*c+2*f+2*l-3);return o[0][2]=o[1][2]=o[2][2]=D(a*u),o[2][1]=-D(1-u),o[1][1]=(f-u)/o[2][1],o[0][1]=(l-u)/o[2][1],o[1][0]=-D(1-o[1][1]**2-u),o[0][0]=D(1-o[0][1]**2-u),a===0&&(o[2][2]=.5),o}else if(s===4){const c=n[0][1],f=n[1][2],l=n[2][3],u=n[0][2],d=n[1][3],m=n[0][3],p=(c*c*l*l+f*f*m*m+u*u*d*d-c*c-f*f-l*l-u*u-d*d-m*m+2*c*d*m+2*c*f*u+2*f*l*d+2*l*u*m-2*f*u*d*m-2*c*f*l*m-2*c*l*u*d+1)/(2*(c*c*l+f*f*m+l*l*c+u*u*d+d*d*u+m*m*f-c*c-f*f-l*l-u*u-d*d-m*m-c*f*l-c*f*m-c*l*u-c*l*d-c*l*m-c*u*d-f*l*m-f*u*d-f*u*m-f*d*m-l*u*d-u*d*m+c*f*u+c*d*m+f*l*d+l*u*m+c*f+c*u+c*d+c*m+f*l+f*u+f*d+l*u+l*d+l*m+u*m+d*m-c-f-l-u-d-m+2));return o[0][3]=o[1][3]=o[2][3]=o[3][3]=D(a*p),o[3][2]=-D(1-p),o[2][2]=(l-p)/o[3][2],o[1][2]=(d-p)/o[3][2],o[0][2]=(m-p)/o[3][2],o[2][1]=-D(1-p-o[2][2]**2),o[1][1]=(f-p-o[1][2]*o[2][2])/o[2][1],o[0][1]=(u-p-o[0][2]*o[2][2])/o[2][1],o[1][0]=-D(1-p-o[1][1]**2-o[1][2]**2),o[0][0]=D(1-p-o[0][1]**2-o[0][2]**2),a===0&&(o[3][3]=.5),o}if(n.every((c,f)=>c.every((l,u)=>f===u||l===-1))){const c=[0];for(let f=1;f<s;f++)c[f]=(c[f-1]+1)/(3-c[f-1]);o[0][0]=1,o[1][0]=-1,o[0][1]=D(c[1]),o[1][1]=D(c[1]);for(let f=0;f<s;f++)for(let l=0;l<s;l++)f<2&&l<2||(o[f][l]=l<f-1?0:l===f-1?f*D(c[l]-c[l-1]):l<s-1?D(c[l]-c[l-1]):D(c[l-1]));return o}}},Bn=(e,t)=>{const n=g.useRef({previous:null,anteprevious:null,start:null,stable:!1});g.useEffect(()=>{const s=16.666666666666668;if(e.adaptative){let a=null,o=null,i=[];const c=20,f=10,l=u=>{if(o===null){n.current.start===null&&(n.current.start=u),o=u,a=requestAnimationFrame(l);return}if(i.push(u-o),o=u,i.length>$e(c,f)&&i.shift(),i.length>=f&&i.slice(-f).reduce((m,p)=>m+p,0)/f>(n.current.stable?2.01:1.51)*s){i=[],n.current.stable=!1;const m=W.indexOf(e.detail);if(m>1){n.current.anteprevious=n.current.previous,n.current.previous=e.detail;const p=W[m-1];t(v=>({...v,detail:p}))}}if(i.length>=c&&i.slice(-c).reduce((m,p)=>m+p,0)/c<(n.current.stable?1.001:1.01)*s){i=[],n.current.stable=!1;const m=W.indexOf(e.detail);if(m<W.length-2){const p=W[m+1];p===n.current.previous&&e.detail===n.current.anteprevious&&u-n.current.start>1e3?n.current.stable=!0:(n.current.anteprevious=n.current.previous,n.current.previous=e.detail,t(v=>({...v,detail:p})))}}a=requestAnimationFrame(l)};return a=requestAnimationFrame(l),()=>cancelAnimationFrame(a)}},[e.detail,e.adaptative,e.ambiance,e.space,t]),g.useEffect(()=>{n.current={previous:null,anteprevious:null,stable:!1,start:null}},[e.space,e.shaper,e.ambiance])};class ge extends g.Component{constructor(t){super(t),this.state={error:!1}}static getDerivedStateFromError(t){return{error:!0}}static getDerivedStateFromProps(t){return{error:t.error}}componentDidCatch(t,n){this.props.onError(t,n)}render(){return this.state.error?null:this.props.children}}var tn={exports:{}};(function(e,t){(function(n,s){e.exports=s()})(In,function(){var n=function(){function s(p){return i.appendChild(p.dom),p}function a(p){for(var v=0;v<i.children.length;v++)i.children[v].style.display=v===p?"block":"none";o=p}var o=0,i=document.createElement("div");i.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",i.addEventListener("click",function(p){p.preventDefault(),a(++o%i.children.length)},!1);var c=(performance||Date).now(),f=c,l=0,u=s(new n.Panel("FPS","#0ff","#002")),d=s(new n.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var m=s(new n.Panel("MB","#f08","#201"));return a(0),{REVISION:16,dom:i,addPanel:s,showPanel:a,begin:function(){c=(performance||Date).now()},end:function(){l++;var p=(performance||Date).now();if(d.update(p-c,200),p>f+1e3&&(u.update(1e3*l/(p-f),100),f=p,l=0,m)){var v=performance.memory;m.update(v.usedJSHeapSize/1048576,v.jsHeapSizeLimit/1048576)}return p},update:function(){c=this.end()},domElement:i,setMode:a}};return n.Panel=function(s,a,o){var i=1/0,c=0,f=Math.round,l=f(window.devicePixelRatio||1),u=80*l,d=48*l,m=3*l,p=2*l,v=3*l,b=15*l,I=74*l,N=30*l,j=document.createElement("canvas");j.width=u,j.height=d,j.style.cssText="width:80px;height:48px";var S=j.getContext("2d");return S.font="bold "+9*l+"px Helvetica,Arial,sans-serif",S.textBaseline="top",S.fillStyle=o,S.fillRect(0,0,u,d),S.fillStyle=a,S.fillText(s,m,p),S.fillRect(v,b,I,N),S.fillStyle=o,S.globalAlpha=.9,S.fillRect(v,b,I,N),{dom:j,update:function(R,M){i=Math.min(i,R),c=Math.max(c,R),S.fillStyle=o,S.globalAlpha=1,S.fillRect(0,0,u,b),S.fillStyle=a,S.fillText(f(R)+" "+s+" ("+f(i)+"-"+f(c)+")",m,p),S.drawImage(j,v+l,b,I-l,N,v,b,I-l,N),S.fillRect(v+I-l,b,l,N),S.fillStyle=o,S.globalAlpha=.9,S.fillRect(v+I-l,b,l,f((1-R/M)*N))}}},n})})(tn);var Hn=tn.exports;const Vn=jn(Hn),qn=`const vec2 cone = vec2(1., 0);
...
#endloopN
`,Wn=`const float ambient = AMBIENT;
...
`,Object.entries({...nt,config:o}).forEach(([u,d])=>{t=t.replace(`#include ${u}`,d),n=n.replace(`#include ${u}`,d)}),[t,n].map(u=>rt(u,e.dimensions))},ie=(e,t,n,s,a)=>{if(e.gl.shaderSource(a,s),e.gl.compileShader(a),!e.gl.getShaderParameter(a,e.gl.COMPILE_STATUS)){const i=e.gl.getShaderInfoLog(a);return console.error(`An error occurred compiling the ${t}->${n} shader: ${i}`,{shaderSource:s}),i}},_e=(e,t,n)=>{const{gl:s}=e;if(s.linkProgram(n),!s.getProgramParameter(n,s.LINK_STATUS)){const o=s.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${o}`),o}},rn=(e,t,n,s,a=[])=>{const{gl:o}=e,i=o.createProgram(),c=o.createShader(o.VERTEX_SHADER),f=o.createShader(o.FRAGMENT_SHADER);if(ie(e,t,"vertex",n,c)||ie(e,t,"fragment",s,f)||(o.attachShader(i,c),o.attachShader(i,f),_e(e,t,i)))return;const l={program:i,vertexShader:c,fragmentShader:f,uniformsDef:a,recompile(u,d,m,p=null){ie(u,t,"vertex",d,this.vertexShader)||ie(u,t,"fragment",m,this.fragmentShader)||_e(u,t,this.program)||(p&&(this.uniformsDef=p),this.bindUniforms(u))},bindUniforms(u){this.uniforms={},this.uniformsDef.forEach(({name:d,type:m,value:p})=>{this.uniforms[d]=at(u,this.program,d,m),this.uniforms[d].update(p)})}};return l.bindUniforms(e),l},ee=(e,t,n,s,a,o=null,i=null)=>{const{gl:c}=e;i=i||c.FLOAT;const f=i===c.FLOAT?4:2,l={name:n,mesh:t,indices:an,instances:o,data:a,size:s,type:i,update(u=null,d=null,m=null){c.bindVertexArray(this.mesh.vao),c.bindBuffer(c.ARRAY_BUFFER,this.buffer),u===null&&d===null&&m===null?c.bufferData(c.ARRAY_BUFFER,this.data,c.STATIC_DRAW):(this.data.set(u,d*this.size),c.bufferSubData(c.ARRAY_BUFFER,d*this.size*f,this.data,d*this.size,m*this.size))},extend(u,d,m=!1){if(c.bindVertexArray(this.mesh.vao),this.size=u,d&&(m&&d.length>=this.data.length&&d.set(this.data),this.data=d),this.location=c.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;c.bindBuffer(c.ARRAY_BUFFER,this.buffer);const p=u>4?3:1;for(let v=0;v<p;v++)c.enableVertexAttribArray(this.location+v);for(let v=0;v<p;v++)c.vertexAttribPointer(this.location+v,u/p,this.type,!1,u*f,u/p*v*f);for(let v=0;v<p;v++)c.vertexAttribDivisor(this.location+v,this.instances||0);this.update()},get(){c.bindVertexArray(this.mesh.vao),c.bindBuffer(c.ARRAY_BUFFER,this.buffer);const u=new Float32Array(this.data.length);return c.getBufferSubData(c.ARRAY_BUFFER,0,u),u}};return l.buffer=c.createBuffer(),l.extend(s),l},an=(e,t,n)=>{const{gl:s}=e;s.bindVertexArray(t);const a=s.createBuffer();return s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,a),s.bufferData(s.ELEMENT_ARRAY_BUFFER,n,s.STATIC_DRAW),{buffer:a,vao:t,indices:n,count:n.length,update(o){s.bindVertexArray(this.vao),this.indices=o,this.count=o.length,s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,this.buffer),s.bufferData(s.ELEMENT_ARRAY_BUFFER,o,s.STATIC_DRAW)}}},at=(e,t,n,s)=>{const{gl:a}=e;return{program:t,update(i){if(a.useProgram(this.program),s.startsWith("m")){const c=parseInt(s.slice(1,2));if(c>4)for(let f=0;f<c;f++){const l=a.getUniformLocation(t,`${n}.c${f+1}.v`);if(l!==null&&a.uniform4fv(l,i[f][0]),c-4===1){const u=a.getUniformLocation(t,`${n}.c${f+1}.u`);u!==null&&a.uniform1f(u,i[f][1])}else if(c-4>1){const u=a.getUniformLocation(t,`${n}.c${f+1}.u`);if(u!==null&&a[`uniform${V(c-4,4)}fv`](u,i[f][1]),c-8===1){const d=a.getUniformLocation(t,`${n}.c${f+1}.t`);d!==null&&a.uniform1f(d,i[f][2])}}}else{const f=a.getUniformLocation(t,n);f!==null&&a[`uniformMatrix${s.slice(1)}`](f,!1,i)}}else{const c=a.getUniformLocation(t,n);c!==null&&a[`uniform${s}`](c,i)}},get(){a.useProgram(this.program);const i=a.getUniformLocation(t,n);if(i!==null)return a.getUniform(this.program,i)}}},G=(e,t,n=null)=>{const{gl:s}=e,a=n?~~(n*s.drawingBufferWidth):s.drawingBufferWidth,o=n?~~(n*s.drawingBufferHeight):s.drawingBufferHeight,i=s.createTexture();return s.bindTexture(s.TEXTURE_2D,i),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE),s.texStorage2D(s.TEXTURE_2D,1,t,a,o),{texture:i,width:a,height:o}},ne=(e,t,n,s,a=[])=>{const o={name:t,vertex:n,fragment:s,...rn(e,t,n,s,a),recompileProgram(i){this.recompile(i,this.vertex,this.fragment,a)}};return{[t]:o}},Ee=(e,t,n,s,a,o,i,c=["position"])=>{var m;const{gl:f}=e,l=a(((m=e.space)==null?void 0:m.curvature)&&e.curve,e.detail),u=p=>[{name:"viewProjection",type:"m4fv",value:K(q(4))},{name:"matrix",type:`m${p.dimensions}fv`,value:K(p.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${p.dimensions}fv`,value:K(q(p.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...P(3,p.dimensions+1,1,!0).map(v=>({name:`fov${v}`,type:"1f",value:p[`fov${v}`]}))];i=i>4?9:i;const d={attributes:{},varying:c,vertex:n,type:t,fragment:s,...rn(e,t,...Me(e,n,s,t),u(e)),recompileProgram(p){const[v,b]=Me(p,this.vertex,this.fragment,this.type);this.recompile(p,v,b,u(p))},changeArity(p){p=p>4?9:p,this.arity!==p&&(this.arity=p,this.extendAttributes(this.instances))},extendAttributes(p){this.instances=p,c.forEach(v=>{this.attributes[v].extend(this.arity,new Float32Array(p*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(p*3),!0)},updateGeometry(p){const v=a(p.space.curvature&&p.curve,p.detail);this.indices.update(new Uint16Array(v.indices)),this.attributes.vertex.extend(3,new Float32Array(v.vertices)),this.attributes.uv.extend(2,new Float32Array(v.uvs)),this.attributes.normal.extend(3,new Float32Array(v.normals))},render(p){this.count&&(f.useProgram(this.program),f.bindVertexArray(this.vao),f.drawElementsInstanced(f.TRIANGLES,this.indices.count,f.UNSIGNED_SHORT,0,this.count))}};return d.vao=f.createVertexArray(),d.indices=an(e,d.vao,new Uint16Array(l.indices)),d.attributes.vertex=ee(e,d,"vertex",3,new Float32Array(l.vertices)),d.attributes.uv=ee(e,d,"uv",2,new Float32Array(l.uvs)),d.attributes.normal=ee(e,d,"normal",3,new Float32Array(l.normals)),d.attributes.color=ee(e,d,"color",3,new Float32Array(o*3),1),c.forEach(p=>{d.attributes[p]=ee(e,d,p,i,new Float32Array(o*i),1)}),d.type=t,d.arity=i,d.instances=o,d.count=0,{[t]:d}},Ne=(e,t,n,s)=>{const{gl:a}=e;a.bindRenderbuffer(a.RENDERBUFFER,t),s?a.renderbufferStorageMultisample(a.RENDERBUFFER,s,n,a.drawingBufferWidth,a.drawingBufferHeight):a.renderbufferStorage(a.RENDERBUFFER,n,a.drawingBufferWidth,a.drawingBufferHeight),a.bindRenderbuffer(a.RENDERBUFFER,null)},ot=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const s=[],a=[],o=[],i=[];let c=0;const f=[];for(let l=0;l<=n;l++){const u=[],d=l/n;let m=0;l===0?m=.5/t:l===n&&(m=-.5/t);for(let p=0;p<=t;p++){const v=p/t,b=[-e*ue(v*Ie)*re(d*H),e*ue(d*H),e*re(v*Ie)*re(d*H)];a.push(...b);const I=(b[0]**2+b[1]**2+b[2]**2)**-.5;o.push(...b.map(N=>N*I)),i.push(v+m,1-d),u.push(c++)}f.push(u)}for(let l=0;l<n;l++)for(let u=0;u<t;u++){const d=f[l][u+1],m=f[l][u],p=f[l+1][u],v=f[l+1][u+1];l!==0&&s.push(d,m,v),l!==n-1&&s.push(m,p,v)}return{vertices:a,normals:o,uvs:i,indices:s}},st=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:s=1,radialSegments:a=8,segments:o=1}={})=>{const i=[],c=[],f=[],l=[];e!==null&&(t=e,n=e);let u=0;const d=[],m=s/2,p=(n-t)/s;for(let v=0;v<=o;v++){const b=[],I=v/o,N=I*(n-t)+t;for(let j=0;j<=a;j++){const S=j/a,R=S*Ie,M=re(R),L=ue(R),Z=[N*M,-I*s+m,N*L];c.push(...Z);const z=[M,p,L],_=(z[0]**2+z[1]**2+z[2]**2)**-.5;f.push(...z.map(ae=>ae*_)),l.push(S,1-I),b.push(u++)}d.push(b)}for(let v=0;v<a;v++)for(let b=0;b<o;b++){const I=d[b][v],N=d[b+1][v],j=d[b+1][v+1],S=d[b][v+1];i.push(I,N,S),i.push(N,j,S)}return{vertices:c,normals:f,uvs:l,indices:i}},it=({segments:e=3}={})=>{const t=[],n=[],s=[],a=[],o=1/e;for(let i=0;i<e+1;i++)for(let c=0;c<i+1;c++)n.push((2*c-i)*o/2,i*o,0),s.push(0,0,1),a.push(o*c,1-o*i);for(let i=1;i<e+1;i++)for(let c=0;c<i;c++){const f=i*(i+1)/2+c,l=i*(i-1)/2+c;if(t.push(f,l,f+1),i<e){const u=(i+1)*(i+2)/2+c;t.push(u+1,f,f+1)}}return{vertices:n,normals:s,uvs:a,indices:t}},ct=`#include globals
#include fragment
`,lt=`#include globals
#include dimensions
