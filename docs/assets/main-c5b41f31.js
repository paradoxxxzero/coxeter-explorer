...
`),Object.entries({...mt,config:i}).forEach(([c,l])=>{t=t.replace(`#include ${c}`,l),n=n.replace(`#include ${c}`,l)}),[t,n].map(c=>vt(c,e.dimensions))},fe=(e,t,n,o,r)=>{if(e.gl.shaderSource(r,o),e.gl.compileShader(r),!e.gl.getShaderParameter(r,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(r);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},Ye=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},Nn=(e,t,n,o,r=[])=>{const{gl:i}=e,s=i.createProgram(),d=i.createShader(i.VERTEX_SHADER),f=i.createShader(i.FRAGMENT_SHADER);if(fe(e,t,"vertex",n,d)||fe(e,t,"fragment",o,f)||(i.attachShader(s,d),i.attachShader(s,f),Ye(e,t,s)))return;const c={program:s,vertexShader:d,fragmentShader:f,uniformsDef:r,recompile(l,m,h,v=null){fe(l,t,"vertex",m,this.vertexShader)||fe(l,t,"fragment",h,this.fragmentShader)||Ye(l,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(l))},bindUniforms(l){this.uniforms={},this.uniformsDef.forEach(({name:m,type:h,value:v})=>{this.uniforms[m]=ht(l,this.program,m,h),this.uniforms[m].update(v)})}};return c.bindUniforms(e),c},te=(e,t,n,o,r,i=null,s=null)=>{const{gl:d}=e;s=s||d.FLOAT;const f=s===d.FLOAT?4:2,c={name:n,mesh:t,indices:yn,instances:i,data:r,size:o,type:s,update(l=null,m=null,h=null){this.location!==-1&&(d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer),l===null&&m===null&&h===null?d.bufferData(d.ARRAY_BUFFER,this.data,d.STATIC_DRAW):(this.data.set(l,m*this.size),d.bufferSubData(d.ARRAY_BUFFER,m*this.size*f,this.data,m*this.size,h*this.size)))},extend(l,m,h=!1){if(d.bindVertexArray(this.mesh.vao),this.size=l,m&&(h&&m.length>=this.data.length&&m.set(this.data),this.data=m),this.location=d.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const v=l>4?3:1;for(let p=0;p<v;p++)d.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)d.vertexAttribPointer(this.location+p,l/v,this.type,!1,l*f,l/v*p*f);for(let p=0;p<v;p++)d.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},refresh(){this.extend(this.size,this.data)},get(){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const l=new Float32Array(this.data.length);return d.getBufferSubData(d.ARRAY_BUFFER,0,l),l}};return c.buffer=d.createBuffer(),c.extend(o),c},yn=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const r=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,r),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:r,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},ht=(e,t,n,o)=>{const{gl:r}=e;return{program:t,update(s){if(r.useProgram(this.program),!o.startsWith("m0"))if(o.startsWith("m1")&&(o=o.replace("m","")),o.startsWith("m")){const d=parseInt(o.slice(1,2));if(d>4)for(let f=0;f<d;f++){const c=r.getUniformLocation(t,`${n}.c${f+1}.v`);if(c!==null&&r.uniform4fv(c,s[f][0]),d-4===1){const l=r.getUniformLocation(t,`${n}.c${f+1}.u`);l!==null&&r.uniform1f(l,s[f][1])}else if(d-4>1){const l=r.getUniformLocation(t,`${n}.c${f+1}.u`);if(l!==null&&r[`uniform${G(d-4,4)}fv`](l,s[f][1]),d-8===1){const m=r.getUniformLocation(t,`${n}.c${f+1}.t`);m!==null&&r.uniform1f(m,s[f][2])}}}else{const f=r.getUniformLocation(t,n);f!==null&&r[`uniformMatrix${o.slice(1)}`](f,!1,s)}}else{const d=r.getUniformLocation(t,n);d!==null&&r[`uniform${o}`](d,s)}},get(){r.useProgram(this.program);const s=r.getUniformLocation(t,n);if(s!==null)return r.getUniform(this.program,s)}}},q=(e,t,n=null)=>{const{gl:o}=e,r=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,r,i),{texture:s,width:r,height:i}},oe={},Ee=["texture","normal","displacement"],gt=(e,t,n)=>{const{gl:o}=e,r={width:4096,height:4096,listeners:[]};for(let i=0;i<Ee.length;i++){const s=Ee[i];o.activeTexture(o[`TEXTURE${n+i}`]),r[s]=o.createTexture(),o.bindTexture(o.TEXTURE_2D,r[s]);const d=`textures/${t}/${s}.jpg`;let f=oe[d]||null;if(o.texImage2D(o.TEXTURE_2D,0,o.RGBA,r.width,r.height,0,o.RGBA,o.UNSIGNED_BYTE,f!=null&&f.complete?f:null),o.generateMipmap(o.TEXTURE_2D),f||(f=new Image,f.src=d,oe[d]=f),!f.complete){const c=()=>{r.listeners.splice(r.listeners.findIndex(([l])=>l===f),1),oe[d]=f,o.activeTexture(o[`TEXTURE${n+i}`]),o.bindTexture(o.TEXTURE_2D,r[s]),o.texImage2D(o.TEXTURE_2D,0,o.RGBA,o.RGBA,o.UNSIGNED_BYTE,f),o.generateMipmap(o.TEXTURE_2D),Y(e)};f.addEventListener("load",c),r.listeners.push([f,c])}}return r},xt=(e,t)=>{const{gl:n}=e;for(let o=0;o<Ee.length;o++){const r=Ee[o];n.deleteTexture(t[r])}},Ze=(e,t,n)=>{const{gl:o}=e;o.activeTexture(o[`TEXTURE${n}`]);const r={texture:o.createTexture(),width:2048,height:2048,listeners:[]};o.bindTexture(o.TEXTURE_CUBE_MAP,r.texture);const i=Object.entries({px:o.TEXTURE_CUBE_MAP_POSITIVE_X,nx:o.TEXTURE_CUBE_MAP_NEGATIVE_X,py:o.TEXTURE_CUBE_MAP_POSITIVE_Y,ny:o.TEXTURE_CUBE_MAP_NEGATIVE_Y,pz:o.TEXTURE_CUBE_MAP_POSITIVE_Z,nz:o.TEXTURE_CUBE_MAP_NEGATIVE_Z});for(let s=0;s<i.length;s++){const[d,f]=i[s],c=`cubemaps/${t}/${d}.jpg`;let l=oe[c]||null;if(o.texImage2D(f,0,o.RGBA,r.width,r.height,0,o.RGBA,o.UNSIGNED_BYTE,l!=null&&l.complete?l:null),o.generateMipmap(o.TEXTURE_CUBE_MAP),l||(l=new Image,l.src=c,oe[c]=l),!l.complete){const m=()=>{r.listeners.splice(r.listeners.findIndex(([h])=>h===l),1),oe[c]=l,o.activeTexture(o[`TEXTURE${n}`]),o.bindTexture(o.TEXTURE_CUBE_MAP,r.texture),o.texImage2D(f,0,o.RGBA,o.RGBA,o.UNSIGNED_BYTE,l),o.generateMipmap(o.TEXTURE_CUBE_MAP),Y(e)};l.addEventListener("load",m),r.listeners.push([l,m])}}return r},ze=e=>{e.listeners.forEach(([t,n])=>{t.removeEventListener("load",n)}),e.listeners=[]},ae=(e,t,n,o,r=[])=>{const i={name:t,vertex:n,fragment:o,...Nn(e,t,n,o,r),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,r)}};return{[t]:i}},je=(e,t,n,o)=>{const{gl:r}=e;r.bindRenderbuffer(r.RENDERBUFFER,t),o?r.renderbufferStorageMultisample(r.RENDERBUFFER,o,n,r.drawingBufferWidth,r.drawingBufferHeight):r.renderbufferStorage(r.RENDERBUFFER,n,r.drawingBufferWidth,r.drawingBufferHeight),r.bindRenderbuffer(r.RENDERBUFFER,null)},bt=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],r=[],i=[],s=[];let d=0;const f=[];for(let c=0;c<=n;c++){const l=[],m=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,b=[-e*De(p*Ce)*me(m*K),e*De(m*K),e*me(p*Ce)*me(m*K)];r.push(...b);const y=(b[0]**2+b[1]**2+b[2]**2)**-.5;i.push(...b.map(N=>N*y)),s.push(p+h,1-m),l.push(d++)}f.push(l)}for(let c=0;c<n;c++)for(let l=0;l<t;l++){const m=f[c][l+1],h=f[c][l],v=f[c+1][l],p=f[c+1][l+1];c!==0&&o.push(m,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:r,normals:i,uvs:s,indices:o}},Et=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:r=8,segments:i=1}={})=>{const s=[],d=[],f=[],c=[];e!==null&&(t=e,n=e);let l=0;const m=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const b=[],y=p/i,N=y*(n-t)+t;for(let j=0;j<=r;j++){const T=j/r,C=T*Ce,B=me(C),L=De(C),ie=[N*B,-y*o+h,N*L];d.push(...ie);const P=[B,v,L],k=(P[0]**2+P[1]**2+P[2]**2)**-.5;f.push(...P.map(we=>we*k)),c.push(T,1-y),b.push(l++)}m.push(b)}for(let p=0;p<r;p++)for(let b=0;b<i;b++){const y=m[b][p],N=m[b+1][p],j=m[b+1][p+1],T=m[b][p+1];s.push(y,N,T),s.push(N,j,T)}return{vertices:d,normals:f,uvs:c,indices:s}},Nt=({segments:e=3}={})=>{const t=[],n=[],o=[],r=[],i=1/e;for(let s=0;s<e+1;s++)for(let d=0;d<s+1;d++)n.push((2*d-s)*i/2,s*i,0),o.push(0,0,1),r.push(i*s,i*d);for(let s=1;s<e+1;s++)for(let d=0;d<s;d++){const f=s*(s+1)/2+d,c=s*(s-1)/2+d;if(t.push(f,c,f+1),s<e){const l=(s+1)*(s+2)/2+d;t.push(l+1,f,f+1)}}return{vertices:n,normals:o,uvs:r,indices:t}},yt=`#include globals
#include fragment
`,wt=`#include globals
#include dimensions
#define EDGE
