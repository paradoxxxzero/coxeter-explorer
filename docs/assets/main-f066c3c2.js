...
`,gt={globals:dt,dimensions:ct,project:mt,helpers:ft,complex:it,fragment:lt,vertexouthead:vt,lighting:ut,vertexout:pt},bt=(e,t,n)=>{t=n?1:t||1,t=Math.max(0,t);const o=n?n.width:e.clientWidth*t|0,a=n?n.height:e.clientHeight*t|0;return e.width!==o||e.height!==a?(e.width=o,e.height=a,!0):!!n},Re=(e,t)=>e.replace(/\bvecN\b/g,`vec${t}`).replace(/\bmatN\b/g,`mat${t}`).replace(/\bfovN\b/g,`fov${t}`).replace(/\bvecN_1\b/g,`vec${t-1}`).replace(/\bvec1\b/g,"float").replace(/\b_N_\b/g,`${t}`).replace(/\b_Nf_\b/g,`${t}.`).replace(/\PROJECTION_N\b/g,`PROJECTION${t}`).replace(/\bvec[01]\b/g,"float").replace(/\bmat[01]\b/g,"float"),Et=(e,t)=>Re(e.replace(/#loopN(\d)(.+?)#endloopN/gs,(n,o,a)=>{const i=[];for(let s=o;s<=t;s++)i.push(Re(a.replace(/#ifN(\d)(.+?)(#elseN(.+?)):?#endifN/gs,(d,u,c,l,m)=>u===`${s}`?Re(c,s):m||""),s));return i.join(`
`)}),t),Ye=(e,t,n,o)=>{var u;const a=U[e.ambiance];let i="";const s=c=>c.toString().includes(".")?c:`${c}.`;Object.entries({shading:c=>_n.indexOf(c),diffuse:c=>Fn.indexOf(c),specular:c=>Mn.indexOf(c),ambient:c=>s(c),shininess:c=>s(c),metalness:c=>s(c),roughness:c=>s(c),opacity:c=>s(c),gouraud:c=>"",envmap:c=>c?!0:null,texture:c=>c?!0:null,reversed:c=>c?!0:null,tint:c=>c?!0:null,fresnel:c=>c?s(c):null,tesselation:c=>c==="full"?1:0}).forEach(([c,l])=>{const m=Object.keys(a).includes(o)&&Object.keys(a[o]).includes(c)?a[o][c]:a[c];if(m!==!1){let p=l(m);p===!0&&(p=""),p!==null&&(i+=`#define ${c.toUpperCase()} ${p}
...
`),v=fe(0,l-m),h=B(p.length,l+m);u=p.slice(v,h).map((E,N)=>(N===m-1?"=>":"  ")+E).join(`
`)}return console.error(`An error occurred compiling the ${t}->${n} shader: ${d}`,u),d}},ze=(e,t,n)=>{if(e.linkProgram(n),!e.getProgramParameter(n,e.LINK_STATUS)){const a=e.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${a}`),a}},wn=(e,t,n,o,a=[])=>{const{gl:i}=e,s=i.createProgram(),d=i.createShader(i.VERTEX_SHADER),u=i.createShader(i.FRAGMENT_SHADER);if(ie(i,t,"vertex",n,d)||ie(i,t,"fragment",o,u)||(i.attachShader(s,d),i.attachShader(s,u),ze(i,t,s)))return;const c={program:s,vertexShader:d,fragmentShader:u,uniformsDef:a,recompile(l,m,p,v=null){ie(i,t,"vertex",m,this.vertexShader)||ie(i,t,"fragment",p,this.fragmentShader)||ze(i,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(l))},bindUniforms(l){this.uniforms={},this.uniformsDef.forEach(({name:m,type:p,value:v})=>{this.uniforms[m]=Nt(l,this.program,m,p),this.uniforms[m].update(v)})}};return c.bindUniforms(e),c},re=(e,t,n,o,a,i=null,s=null)=>{const{gl:d}=e;s=s||d.FLOAT;const u=s===d.FLOAT?4:2,c={name:n,mesh:t,indices:yn,instances:i,data:a,size:o,type:s,update(l=null,m=null,p=null){this.location!==-1&&(d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer),l===null&&m===null&&p===null?d.bufferData(d.ARRAY_BUFFER,this.data,d.STATIC_DRAW):(this.data.set(l,m*this.size),d.bufferSubData(d.ARRAY_BUFFER,m*this.size*u,this.data,m*this.size,p*this.size)))},extend(l,m,p=!1){if(d.bindVertexArray(this.mesh.vao),this.size=l,m&&(p&&m.length>=this.data.length&&m.set(this.data),this.data=m),this.location=d.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const v=l>4?3:1;for(let h=0;h<v;h++)d.enableVertexAttribArray(this.location+h);for(let h=0;h<v;h++)d.vertexAttribPointer(this.location+h,l/v,this.type,!1,l*u,l/v*h*u);for(let h=0;h<v;h++)d.vertexAttribDivisor(this.location+h,this.instances||0);this.update()},refresh(){this.extend(this.size,this.data)},get(){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const l=new Float32Array(this.data.length);return d.getBufferSubData(d.ARRAY_BUFFER,0,l),l}};return c.buffer=d.createBuffer(),c.extend(o),c},yn=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const a=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,a),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:a,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},Nt=(e,t,n,o)=>{const{gl:a}=e;return{program:t,update(s){if(a.useProgram(this.program),!o.startsWith("m0"))if(o.startsWith("m1")&&(o=o.replace("m","")),o.startsWith("m")){const d=parseInt(o.slice(1,2));if(d>4)for(let u=0;u<d;u++){const c=a.getUniformLocation(t,`${n}.c${u+1}.v`);if(c!==null&&a.uniform4fv(c,s[u][0]),d-4===1){const l=a.getUniformLocation(t,`${n}.c${u+1}.u`);l!==null&&a.uniform1f(l,s[u][1])}else if(d-4>1){const l=a.getUniformLocation(t,`${n}.c${u+1}.u`);if(l!==null&&a[`uniform${B(d-4,4)}fv`](l,s[u][1]),d-8===1){const m=a.getUniformLocation(t,`${n}.c${u+1}.t`);m!==null&&a.uniform1f(m,s[u][2])}}}else{const u=a.getUniformLocation(t,n);u!==null&&a[`uniformMatrix${o.slice(1)}`](u,!1,s)}}else{const d=a.getUniformLocation(t,n);d!==null&&a[`uniform${o}`](d,s)}},get(){a.useProgram(this.program);const s=a.getUniformLocation(t,n);if(s!==null)return a.getUniform(this.program,s)}}},W=(e,t,n=null)=>{const{gl:o}=e,a=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,a,i),{texture:s,width:a,height:i}},te={},we=["albedo","normal","arm","displacement"],wt=(e,t,n)=>{const{gl:o}=e,a={width:4096,height:4096,listeners:[],index:n};for(let i=0;i<we.length;i++){const s=we[i];o.activeTexture(o.TEXTURE0+a.index+i);const d=ot[t][s];a[s]=o.createTexture(),o.bindTexture(o.TEXTURE_2D,a[s]);let u=d&&te[d]||null;if(o.texImage2D(o.TEXTURE_2D,0,o.RGBA,a.width,a.height,0,o.RGBA,o.UNSIGNED_BYTE,u!=null&&u.src&&(u!=null&&u.complete)?u:null),o.generateMipmap(o.TEXTURE_2D),!d)return a;if(u||(u=new Image,u.crossOrigin="anonymous",te[d]=u),!u.src||!u.complete){const c=()=>{a.listeners.splice(a.listeners.findIndex(([l])=>l===u),1),te[d]=u,o.activeTexture(o.TEXTURE0+a.index+i),o.bindTexture(o.TEXTURE_2D,a[s]),o.texImage2D(o.TEXTURE_2D,0,o.RGBA,o.RGBA,o.UNSIGNED_BYTE,u),o.generateMipmap(o.TEXTURE_2D),Z(e)};u.addEventListener("load",c),u.src=d,a.listeners.push([u,c])}}return a},yt=(e,t)=>{const{gl:n}=e;for(let o=0;o<we.length;o++){const a=we[o];n.deleteTexture(t[a])}},Ze=(e,t,n)=>{const{gl:o}=e,a={texture:o.createTexture(),width:2048,height:2048,index:n,listeners:[]},i=st[t];o.activeTexture(o.TEXTURE0+a.index),o.bindTexture(o.TEXTURE_CUBE_MAP,a.texture);for(let d=0;d<6;d++)o.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+d,0,o.RGBA,a.width,a.height,0,o.RGBA,o.UNSIGNED_BYTE,null);let s=te[i];if(s!=null&&s.src&&(s!=null&&s.complete)&&(Qe(e.gl,s,a),o.bindTexture(o.TEXTURE_CUBE_MAP,a.texture),o.texParameteri(o.TEXTURE_CUBE_MAP,o.TEXTURE_MIN_FILTER,o.LINEAR_MIPMAP_LINEAR),o.generateMipmap(o.TEXTURE_CUBE_MAP)),te[i]||(s=new Image,s.crossOrigin="anonymous",te[i]=s),!s.src||!s.complete){const d=()=>{a.listeners.splice(a.listeners.findIndex(([u])=>u===s),1),o.activeTexture(o.TEXTURE0+a.index),o.bindTexture(o.TEXTURE_CUBE_MAP,a.texture),Qe(e.gl,s,a),o.activeTexture(o.TEXTURE0+a.index),o.bindTexture(o.TEXTURE_CUBE_MAP,a.texture),o.generateMipmap(o.TEXTURE_CUBE_MAP),te[i]=s,Z(e)};s.addEventListener("load",d),s.src=i,a.listeners.push([s,d])}return a},ke=e=>{e.listeners.forEach(([t,n])=>{t.removeEventListener("load",n)}),e.listeners=[]},oe=(e,t,n,o,a=[])=>{const i={name:t,vertex:n,fragment:o,...wn(e,t,n,o,a),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,a)}};return{[t]:i}},Qe=(e,t,n)=>{const o=e.createFramebuffer(),a={width:t.width,height:t.height};e.bindFramebuffer(e.FRAMEBUFFER,o);const i=e.getParameter(e.MAX_TEXTURE_SIZE);if(i<fe(a.width,a.height)){const l=document.createElement("canvas");a.width>a.height?(l.width=e.getParameter(e.MAX_TEXTURE_SIZE),l.height=i/a.width*a.height):(l.height=e.getParameter(e.MAX_TEXTURE_SIZE),l.width=i/a.height*a.width),a.width=l.width,a.height=l.height;const m=l.getContext("2d");m.drawImage(t,0,0,l.width,l.height),t=m.getImageData(0,0,l.width,l.height)}const s=e.createTexture();e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,s),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,a.width,a.height,0,e.RGBA,e.UNSIGNED_BYTE,t),e.generateMipmap(e.TEXTURE_2D);const d=e.createProgram(),u=e.createShader(e.VERTEX_SHADER),c=e.createShader(e.FRAGMENT_SHADER);if(!ie(e,"hdritocube","vertex",ht,u)&&!ie(e,"hdritocube","fragment",xt,c)){e.attachShader(d,u),e.attachShader(d,c),ze(e,"hdritocube",d),e.useProgram(d),e.uniform1i(e.getUniformLocation(d,"hdri"),0),e.uniform1i(e.getUniformLocation(d,"part"),0),e.viewport(0,0,n.width,n.height);for(let l=0;l<6;l++)e.uniform1i(e.getUniformLocation(d,"part"),l),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+l,n.texture,0),e.uniform1i(e.getUniformLocation(d,"face"),l),e.clear(e.COLOR_BUFFER_BIT|e.DEPTH_BUFFER_BIT),e.drawArrays(e.TRIANGLES,0,3);e.deleteTexture(s),e.deleteFramebuffer(o),e.viewport(0,0,e.canvas.width,e.canvas.height)}},Ae=(e,t,n,o)=>{const{gl:a}=e;a.bindRenderbuffer(a.RENDERBUFFER,t),o?a.renderbufferStorageMultisample(a.RENDERBUFFER,o,n,a.drawingBufferWidth,a.drawingBufferHeight):a.renderbufferStorage(a.RENDERBUFFER,n,a.drawingBufferWidth,a.drawingBufferHeight),a.bindRenderbuffer(a.RENDERBUFFER,null)},Tt=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],a=[],i=[],s=[];let d=0;const u=[];for(let c=0;c<=n;c++){const l=[],m=c/n;let p=0;c===0?p=.5/t:c===n&&(p=-.5/t);for(let v=0;v<=t;v++){const h=v/t,E=[-e*_e(h*Fe)*ve(m*Y),e*_e(m*Y),e*ve(h*Fe)*ve(m*Y)];a.push(...E);const N=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(y=>y*N)),s.push(h+p,1-m),l.push(d++)}u.push(l)}for(let c=0;c<n;c++)for(let l=0;l<t;l++){const m=u[c][l+1],p=u[c][l],v=u[c+1][l],h=u[c+1][l+1];c!==0&&o.push(m,p,h),c!==n-1&&o.push(p,v,h)}return{vertices:a,normals:i,uvs:s,indices:o}},St=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:a=8,segments:i=1}={})=>{const s=[],d=[],u=[],c=[];e!==null&&(t=e,n=e);let l=0;const m=[],p=o/2,v=(n-t)/o;for(let h=0;h<=i;h++){const E=[],N=h/i,y=N*(n-t)+t;for(let R=0;R<=a;R++){const I=R/a,_=I*Fe,G=ve(_),L=_e(_),le=[y*G,-N*o+p,y*L];d.push(...le);const z=[G,v,L],H=(z[0]**2+z[1]**2+z[2]**2)**-.5;u.push(...z.map(Se=>Se*H)),c.push(I,1-N),E.push(l++)}m.push(E)}for(let h=0;h<a;h++)for(let E=0;E<i;E++){const N=m[E][h],y=m[E+1][h],R=m[E+1][h+1],I=m[E][h+1];s.push(N,y,I),s.push(y,R,I)}return{vertices:d,normals:u,uvs:c,indices:s}},It=({segments:e=3}={})=>{const t=[],n=[],o=[],a=[],i=1/e;for(let s=0;s<e+1;s++)for(let d=0;d<s+1;d++)n.push((2*d-s)*i/2,s*i,0),o.push(0,0,1),a.push(i*(s-d),i*d);for(let s=1;s<e+1;s++)for(let d=0;d<s;d++){const u=s*(s+1)/2+d,c=s*(s-1)/2+d;if(t.push(u,c,u+1),s<e){const l=(s+1)*(s+2)/2+d;t.push(l+1,u,u+1)}}return{vertices:n,normals:o,uvs:a,indices:t}},jt=`#include globals
#include fragment
`,Rt=`#include globals
#include dimensions
#define EDGE
