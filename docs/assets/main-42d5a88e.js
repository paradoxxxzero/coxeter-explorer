import{r as g,m as ye,a as Oe,p as ke,c as q,i as J,b as $,d as k,e as be,T as Ee,s as oe,P as B,t as _e,f as nn,g as tn,h as je,j as H,k as Ue,l as He,n as te,o as rn,q as an,u as on,v as sn,w as cn,x as ln,y as fn,z as Te,A as un,B as dn,C as r,D as ie,E as Ne,F as Be,G as mn,H as pn,N as _,I as ce,J as vn,K as hn,L as gn,M as Ae}from"./CoxeterMatrix-7c352938.js";var xn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function bn(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}const En="xyzwvutsrqponmlkjihgfedcba",Ve=["perspective","stereographic","orthographic","klein","inverted","scale","joukowsky","half","upperhalf","halfsphere","band","cross","heart","teardrop","square","ring","sinusoidal","spiral","SC_Triangle","SC_Square","SC_Pentagon","SC_Hexagon"],Nn=["ads","normal","position","uv"],wn=["lambert","oren-nayar","minnaert","cel","fresnel","reverse"],Sn=["phong","blinn-phong","cook-torrance","ward-anisotropic"],K=["lowest","lower","low","lowish","medium","highish","high","higher","ultra"],we=["vertex","edge","face"],yn=(e,t)=>{const n=g.useRef({previous:null,anteprevious:null,start:null,stable:!1});g.useEffect(()=>{const s=16.666666666666668;if(e.adaptative){let a=null,i=null,o=[];const l=20,u=10,c=f=>{if(i===null){n.current.start===null&&(n.current.start=f),i=f,a=requestAnimationFrame(c);return}if(o.push(f-i),i=f,o.length>ye(l,u)&&o.shift(),o.length>=u&&o.slice(-u).reduce((h,p)=>h+p,0)/u>(n.current.stable?2.01:1.51)*s){o=[],n.current.stable=!1;const h=K.indexOf(e.detail);if(h>1){n.current.anteprevious=n.current.previous,n.current.previous=e.detail;const p=K[h-1];t(m=>({...m,detail:p}))}}if(o.length>=l&&o.slice(-l).reduce((h,p)=>h+p,0)/l<(n.current.stable?1.001:1.01)*s){o=[],n.current.stable=!1;const h=K.indexOf(e.detail);if(h<K.length-2){const p=K[h+1];p===n.current.previous&&e.detail===n.current.anteprevious&&f-n.current.start>1e3?n.current.stable=!0:(n.current.anteprevious=n.current.previous,n.current.previous=e.detail,t(m=>({...m,detail:p})))}}a=requestAnimationFrame(c)};return a=requestAnimationFrame(c),()=>cancelAnimationFrame(a)}},[e.detail,e.adaptative,e.ambiance,e.space,t]),g.useEffect(()=>{n.current={previous:null,anteprevious:null,stable:!1,start:null}},[e.space,e.shaper,e.ambiance])};class de extends g.Component{constructor(t){super(t),this.state={error:!1}}static getDerivedStateFromError(t){return{error:!0}}static getDerivedStateFromProps(t){return{error:t.error}}componentDidCatch(t,n){this.props.onError(t,n)}render(){return this.state.error?null:this.props.children}}var Ge={exports:{}};(function(e,t){(function(n,s){e.exports=s()})(xn,function(){var n=function(){function s(p){return o.appendChild(p.dom),p}function a(p){for(var m=0;m<o.children.length;m++)o.children[m].style.display=m===p?"block":"none";i=p}var i=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(p){p.preventDefault(),a(++i%o.children.length)},!1);var l=(performance||Date).now(),u=l,c=0,f=s(new n.Panel("FPS","#0ff","#002")),d=s(new n.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=s(new n.Panel("MB","#f08","#201"));return a(0),{REVISION:16,dom:o,addPanel:s,showPanel:a,begin:function(){l=(performance||Date).now()},end:function(){c++;var p=(performance||Date).now();if(d.update(p-l,200),p>u+1e3&&(f.update(1e3*c/(p-u),100),u=p,c=0,h)){var m=performance.memory;h.update(m.usedJSHeapSize/1048576,m.jsHeapSizeLimit/1048576)}return p},update:function(){l=this.end()},domElement:o,setMode:a}};return n.Panel=function(s,a,i){var o=1/0,l=0,u=Math.round,c=u(window.devicePixelRatio||1),f=80*c,d=48*c,h=3*c,p=2*c,m=3*c,E=15*c,T=74*c,S=30*c,R=document.createElement("canvas");R.width=f,R.height=d,R.style.cssText="width:80px;height:48px";var y=R.getContext("2d");return y.font="bold "+9*c+"px Helvetica,Arial,sans-serif",y.textBaseline="top",y.fillStyle=i,y.fillRect(0,0,f,d),y.fillStyle=a,y.fillText(s,h,p),y.fillRect(m,E,T,S),y.fillStyle=i,y.globalAlpha=.9,y.fillRect(m,E,T,S),{dom:R,update:function(F,L){o=Math.min(o,F),l=Math.max(l,F),y.fillStyle=i,y.globalAlpha=1,y.fillRect(0,0,f,E),y.fillStyle=a,y.fillText(u(F)+" "+s+" ("+u(o)+"-"+u(l)+")",h,p),y.drawImage(R,m+c,E,T-c,S,m,E,T-c,S),y.fillRect(m+T-c,E,c,S),y.fillStyle=i,y.globalAlpha=.9,y.fillRect(m+T-c,E,c,u((1-F/L)*S))}}},n})})(Ge);var jn=Ge.exports;const In=bn(jn),On=`const vec2 cone = vec2(1., 0);
...
`,Fn=`const float ambient = AMBIENT;
...
`,zn=`gl_Position = viewProject(proj);
...
#endif
`,me=(e,t,n)=>(n<0&&(n+=1),n>1&&(n-=1),n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e),C=(e,t,n)=>{let s,a,i;if(t===0)s=a=i=n;else{const o=n<.5?n*(1+t):n+t-n*t,l=2*n-o;s=me(l,o,e+1/3),a=me(l,o,e),i=me(l,o,e-1/3)}return[s,a,i]},re=[[10/360,.56,.91],[0/360,.59,.88],[316/360,.72,.86],[267/360,.84,.81],[343/360,.81,.75],[350/360,.65,.77],[23/360,.92,.75],[41/360,.86,.83],[115/360,.54,.76],[170/360,.57,.73],[189/360,.71,.73],[199/360,.76,.69],[217/360,.92,.76],[232/360,.97,.85]],Pn={background:[0,0,0,1],glow:!1,shading:"ads",diffuse:"lambert",specular:!1,shininess:32,opacity:1,ambient:.2,roughness:.85,gouraud:!1,transparency:"oit",color:({word:e})=>C(e.length*.03%1,.75,.7)},X=Object.fromEntries(Object.entries({neon:{background:[0,0,0,1],glow:{exposure:1.75,strength:2,offset:{up:2,down:2},steps:3,pow:2},shading:!1,face:{opacity:.025},transparency:"blend",color:({word:e,dual:t})=>C((e.length*.17-(t?.43:0))%1,.5,.6)},disco:{background:[0,0,0,1],glow:{exposure:1.5,strength:2,offset:{up:2,down:2},steps:4,pow:2},face:{gouraud:!0,diffuse:"fresnel",opacity:.025},transparency:"blend",color:({word:e})=>C(...re[e.length%re.length])},cathedral:{background:[.6,.6,.6,1],glow:{exposure:1.5,strength:2,offset:{up:2,down:2},steps:4,pow:2},face:{gouraud:!0,opacity:.9},transparency:"oit",color:({word:e,type:t})=>t==="face"?C(e.length*.3%1,1,.6):[0,0,0]},synthwave:{background:[...C(.77,.6,.04),1],glow:{exposure:1.5,strength:3,offset:{up:3,down:3},steps:3,pow:2},shading:!1,face:{opacity:.015},afterImage:.7,transparency:"blend",color:({word:e})=>C((.5-e.length*.05%.5+.65)%1,.4,.6)},colorful:{background:[1,1,1,1],diffuse:"oren-nayar",specular:"cook-torrance",shininess:32,opacity:1,ambient:.2,gouraud:!1,face:{gouraud:!0,opacity:.1,diffuse:"fresnel",specular:!1},transparency:"oit",color:({word:e,dual:t})=>C(e.length*.03%1-(t?.25:0),1,.8)},shiny:{background:[0,0,0,1],diffuse:"lambert",specular:"blinn-phong",shininess:32,opacity:1,ambient:.2,gouraud:!1,face:{gouraud:!0,opacity:.1,diffuse:"fresnel",specular:!1},transparency:"oit",color:({word:e})=>C(-(e.length*.07)%1,1,.8)},shape:{background:[1,1,1,1],transparency:"oit",face:{gouraud:!0,opacity:.2,diffuse:"fresnel"},color:({faceSize:e,type:t,idx:n,size:s})=>t==="face"?C((e-2)*.21%1,1,.8):C(n/s,.75,.5)},subShape:{background:[1,1,1,1],transparency:"oit",face:{gouraud:!0,opacity:.2,diffuse:"fresnel"},color:({subShape:e,type:t})=>t!=="vertex"?C(e*.21%1,1,.8):[1,1,1]},reflection:{background:[1,1,1,1],diffuse:"cel",face:{opacity:.6,gouraud:!1},transparency:"blend",color:({word:e,type:t,dimensions:n,draw:s})=>{const a=e.length?Oe(e[e.length-1])/n:0;return C(a%1,1,t==="face"?.6:s.face?0:.8)}},harlequin:{background:[...C(240/360,.23,.09),1],face:{opacity:.6},transparency:"oit",color:({word:e,idx:t,type:n})=>{const s=e.split("").map(i=>Oe(i)).reduce((i,o)=>i+o,0),a=[...re[s%re.length]];return t%2&&(a[2]*=.5),C(...a)}},pure:{background:[0,0,0,1],color:({word:e})=>C(e.length*.03%1,.75,.7)},facets:{background:[0,0,0,1],color:({faceIndex:e,faceSize:t})=>C(e/t,.75,.7)},monochrome:{background:[.12,.12,.12,1],diffuse:"reverse",ambient:0,face:{opacity:.1},transparency:"oit",color:()=>[1,1,1]},glass:{background:[0,0,0,1],transparency:"blend",opacity:.2,ambient:0,diffuse:"fresnel",specular:"blinn-phong",face:{shininess:16,diffuse:!1},color:({subShape:e,word:t,type:n})=>n!=="vertex"?C((e*.21+t.length*.03)%1,1,.8):[1,1,1]},plain:{extended:!0,background:[1,1,1,1],glow:!1,shading:!1,color:({word:e,type:t,draw:n})=>C(e.length*.06%1,1,t==="face"?.6:n.face?.05:.5)},plainblack:{extended:!0,background:[1,1,1,1],shading:!1,color:({word:e,type:t})=>t==="face"?new Array(3).fill(1-ke(.9,e.length+1)):[0,0,0]},normals:{extended:!0,background:[1,1,1,1],shading:"normal",color:()=>[0,0,0]},uvs:{extended:!0,background:[1,1,1,1],shading:"uv",color:()=>[0,0,0]}}).map(([e,t])=>[e,{...Pn,...t,transparent:{}}])),Ln={globals:An,dimensions:Tn,project:Cn,helpers:Rn,complex:On,fragment:Dn,vertexouthead:Mn,lighting:Fn,vertexout:zn},kn=(e,t,n)=>{t=n?1:t||1,t=Math.max(0,t);const s=n?n.width:e.clientWidth*t|0,a=n?n.height:e.clientHeight*t|0;return e.width!==s||e.height!==a?(e.width=s,e.height=a,!0):!!n},pe=(e,t)=>e.replace(/\bvecN\b/g,`vec${t}`).replace(/\bmatN\b/g,`mat${t}`).replace(/\bfovN\b/g,`fov${t}`).replace(/\bvecN_1\b/g,`vec${t-1}`).replace(/\bvec1\b/g,"float").replace(/\b_N_\b/g,`${t}`).replace(/\b_Nf_\b/g,`${t}.`).replace(/\PROJECTION_N\b/g,`PROJECTION${t}`),_n=(e,t)=>pe(e.replace(/#loopN(\d)(.+?)#endloopN/gs,(n,s,a)=>{const i=[];for(let o=s;o<=t;o++)i.push(pe(a.replace(/#ifN(\d)(.+?)(#elseN(.+?)):?#endifN/gs,(l,u,c,f,d)=>u===`${o}`?pe(c,o):d||""),o));return i.join(`
`)}),t),Re=(e,t,n,s)=>{var u;const a=X[e.ambiance];let i="";const o=c=>c.toString().includes(".")?c:`${c}.`;Object.entries({shading:c=>Nn.indexOf(c),diffuse:c=>wn.indexOf(c),specular:c=>Sn.indexOf(c),ambient:c=>o(c),shininess:c=>o(c),roughness:c=>o(c),opacity:c=>o(c),gouraud:c=>""}).forEach(([c,f])=>{const d=Object.keys(a).includes(s)&&Object.keys(a[s]).includes(c)?a[s][c]:a[c];d!==!1&&(i+=`#define ${c.toUpperCase()} ${f(d)}
`),c==="opacity"&&d<1&&(a.transparent[s]=!0,i+=`#define TRANSPARENT
`,a.transparency==="oit"&&(i+=`#define OIT
`))}),i+=`#define DIMENSIONS ${e.dimensions}
`;for(let c=3;c<=e.dimensions;c++)i+=`#define PROJECTION${c} ${Ve.indexOf(e[`projection${c}`])-1}
`;return i+=`#define CURVATURE ${((u=e.space)==null?void 0:u.curvature)||0}
`,e.curve&&(i+=`#define SEGMENTS
`),Object.entries({...Ln,config:i}).forEach(([c,f])=>{t=t.replace(`#include ${c}`,f),n=n.replace(`#include ${c}`,f)}),[t,n].map(c=>_n(c,e.dimensions))},ae=(e,t,n,s,a)=>{if(e.gl.shaderSource(a,s),e.gl.compileShader(a),!e.gl.getShaderParameter(a,e.gl.COMPILE_STATUS)){const o=e.gl.getShaderInfoLog(a);return console.error(`An error occurred compiling the ${t}->${n} shader: ${o}`,{shaderSource:s}),o}},Fe=(e,t,n)=>{const{gl:s}=e;if(s.linkProgram(n),!s.getProgramParameter(n,s.LINK_STATUS)){const i=s.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},$e=(e,t,n,s,a=[])=>{const{gl:i}=e,o=i.createProgram(),l=i.createShader(i.VERTEX_SHADER),u=i.createShader(i.FRAGMENT_SHADER);if(ae(e,t,"vertex",n,l)||ae(e,t,"fragment",s,u)||(i.attachShader(o,l),i.attachShader(o,u),Fe(e,t,o)))return;const c={program:o,vertexShader:l,fragmentShader:u,uniformsDef:a,recompile(f,d,h,p=null){ae(f,t,"vertex",d,this.vertexShader)||ae(f,t,"fragment",h,this.fragmentShader)||Fe(f,t,this.program)||(p&&(this.uniformsDef=p),this.bindUniforms(f))},bindUniforms(f){this.uniforms={},this.uniformsDef.forEach(({name:d,type:h,value:p})=>{this.uniforms[d]=Un(f,this.program,d,h),this.uniforms[d].update(p)})}};return c.bindUniforms(e),c},Z=(e,t,n,s,a,i=null,o=null)=>{const{gl:l}=e;o=o||l.FLOAT;const u=o===l.FLOAT?4:2,c={name:n,mesh:t,indices:qe,instances:i,data:a,size:s,type:o,update(f=null,d=null,h=null){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer),f===null&&d===null&&h===null?l.bufferData(l.ARRAY_BUFFER,this.data,l.STATIC_DRAW):(this.data.set(f,d*this.size),l.bufferSubData(l.ARRAY_BUFFER,d*this.size*u,this.data,d*this.size,h*this.size))},extend(f,d,h=!1){if(l.bindVertexArray(this.mesh.vao),this.size=f,d&&(h&&d.length>=this.data.length&&d.set(this.data),this.data=d),this.location=l.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const p=f>4?3:1;for(let m=0;m<p;m++)l.enableVertexAttribArray(this.location+m);for(let m=0;m<p;m++)l.vertexAttribPointer(this.location+m,f/p,this.type,!1,f*u,f/p*m*u);for(let m=0;m<p;m++)l.vertexAttribDivisor(this.location+m,this.instances||0);this.update()},get(){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const f=new Float32Array(this.data.length);return l.getBufferSubData(l.ARRAY_BUFFER,0,f),f}};return c.buffer=l.createBuffer(),c.extend(s),c},qe=(e,t,n)=>{const{gl:s}=e;s.bindVertexArray(t);const a=s.createBuffer();return s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,a),s.bufferData(s.ELEMENT_ARRAY_BUFFER,n,s.STATIC_DRAW),{buffer:a,vao:t,indices:n,count:n.length,update(i){s.bindVertexArray(this.vao),this.indices=i,this.count=i.length,s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,this.buffer),s.bufferData(s.ELEMENT_ARRAY_BUFFER,i,s.STATIC_DRAW)}}},Un=(e,t,n,s)=>{const{gl:a}=e;return{program:t,update(o){if(a.useProgram(this.program),s.startsWith("m")){const l=parseInt(s.slice(1,2));if(l>4)for(let u=0;u<l;u++){const c=a.getUniformLocation(t,`${n}.c${u+1}.v`);if(c!==null&&a.uniform4fv(c,o[u][0]),l-4===1){const f=a.getUniformLocation(t,`${n}.c${u+1}.u`);f!==null&&a.uniform1f(f,o[u][1])}else if(l-4>1){const f=a.getUniformLocation(t,`${n}.c${u+1}.u`);if(f!==null&&a[`uniform${k(l-4,4)}fv`](f,o[u][1]),l-8===1){const d=a.getUniformLocation(t,`${n}.c${u+1}.t`);d!==null&&a.uniform1f(d,o[u][2])}}}else{const u=a.getUniformLocation(t,n);u!==null&&a[`uniformMatrix${s.slice(1)}`](u,!1,o)}}else{const l=a.getUniformLocation(t,n);l!==null&&a[`uniform${s}`](l,o)}},get(){a.useProgram(this.program);const o=a.getUniformLocation(t,n);if(o!==null)return a.getUniform(this.program,o)}}},U=(e,t,n=null)=>{const{gl:s}=e,a=n?~~(n*s.drawingBufferWidth):s.drawingBufferWidth,i=n?~~(n*s.drawingBufferHeight):s.drawingBufferHeight,o=s.createTexture();return s.bindTexture(s.TEXTURE_2D,o),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MAG_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,n?s.LINEAR:s.NEAREST),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE),s.texStorage2D(s.TEXTURE_2D,1,t,a,i),{texture:o,width:a,height:i}},Q=(e,t,n,s,a=[])=>{const i={name:t,vertex:n,fragment:s,...$e(e,t,n,s,a),recompileProgram(o){this.recompile(o,this.vertex,this.fragment,a)}};return{[t]:i}},ve=(e,t,n,s,a,i,o,l=["position"])=>{var h;const{gl:u}=e,c=a(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),f=p=>[{name:"viewProjection",type:"m4fv",value:q(J(4))},{name:"matrix",type:`m${p.dimensions}fv`,value:q(p.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${p.dimensions}fv`,value:q(J(p.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...$(3,p.dimensions+1,1,!0).map(m=>({name:`fov${m}`,type:"1f",value:p[`fov${m}`]}))];o=o>4?9:o;const d={attributes:{},varying:l,vertex:n,type:t,fragment:s,...$e(e,t,...Re(e,n,s,t),f(e)),recompileProgram(p){const[m,E]=Re(p,this.vertex,this.fragment,this.type);this.recompile(p,m,E,f(p))},changeArity(p){p=p>4?9:p,this.arity!==p&&(this.arity=p,this.extendAttributes(this.instances))},extendAttributes(p){this.instances=p,l.forEach(m=>{this.attributes[m].extend(this.arity,new Float32Array(p*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(p*3),!0)},updateGeometry(p){const m=a(p.space.curvature&&p.curve,p.detail);this.indices.update(new Uint16Array(m.indices)),this.attributes.vertex.extend(3,new Float32Array(m.vertices)),this.attributes.uv.extend(2,new Float32Array(m.uvs)),this.attributes.normal.extend(3,new Float32Array(m.normals))},fillData(p,m){if(!m){this.count=0;return}this.count=m.start+m.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(p[0],m.start,m.size);for(let E=0;E<this.varying.length;E++){const T=this.varying[E];this.attributes[T].update(p[E+1],m.start,m.size)}},render(p){this.count&&(u.useProgram(this.program),u.bindVertexArray(this.vao),u.drawElementsInstanced(u.TRIANGLES,this.indices.count,u.UNSIGNED_SHORT,0,this.count))}};return d.vao=u.createVertexArray(),d.indices=qe(e,d.vao,new Uint16Array(c.indices)),d.attributes.vertex=Z(e,d,"vertex",3,new Float32Array(c.vertices)),d.attributes.uv=Z(e,d,"uv",2,new Float32Array(c.uvs)),d.attributes.normal=Z(e,d,"normal",3,new Float32Array(c.normals)),d.attributes.color=Z(e,d,"color",3,new Float32Array(i*3),1),l.forEach(p=>{d.attributes[p]=Z(e,d,p,o,new Float32Array(i*o),1)}),d.type=t,d.arity=o,d.instances=i,d.count=0,{[t]:d}},he=(e,t,n,s)=>{const{gl:a}=e;a.bindRenderbuffer(a.RENDERBUFFER,t),s?a.renderbufferStorageMultisample(a.RENDERBUFFER,s,n,a.drawingBufferWidth,a.drawingBufferHeight):a.renderbufferStorage(a.RENDERBUFFER,n,a.drawingBufferWidth,a.drawingBufferHeight),a.bindRenderbuffer(a.RENDERBUFFER,null)},Hn=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const s=[],a=[],i=[],o=[];let l=0;const u=[];for(let c=0;c<=n;c++){const f=[],d=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let p=0;p<=t;p++){const m=p/t,E=[-e*be(m*Ee)*oe(d*B),e*be(d*B),e*oe(m*Ee)*oe(d*B)];a.push(...E);const T=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(S=>S*T)),o.push(m+h,1-d),f.push(l++)}u.push(f)}for(let c=0;c<n;c++)for(let f=0;f<t;f++){const d=u[c][f+1],h=u[c][f],p=u[c+1][f],m=u[c+1][f+1];c!==0&&s.push(d,h,m),c!==n-1&&s.push(h,p,m)}return{vertices:a,normals:i,uvs:o,indices:s}},Bn=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:s=1,radialSegments:a=8,segments:i=1}={})=>{const o=[],l=[],u=[],c=[];e!==null&&(t=e,n=e);let f=0;const d=[],h=s/2,p=(n-t)/s;for(let m=0;m<=i;m++){const E=[],T=m/i,S=T*(n-t)+t;for(let R=0;R<=a;R++){const y=R/a,F=y*Ee,L=oe(F),M=be(F),Y=[S*L,-T*s+h,S*M];l.push(...Y);const D=[L,p,M],z=(D[0]**2+D[1]**2+D[2]**2)**-.5;u.push(...D.map(ne=>ne*z)),c.push(y,1-T),E.push(f++)}d.push(E)}for(let m=0;m<a;m++)for(let E=0;E<i;E++){const T=d[E][m],S=d[E+1][m],R=d[E+1][m+1],y=d[E][m+1];o.push(T,S,y),o.push(S,R,y)}return{vertices:l,normals:u,uvs:c,indices:o}},Vn=({segments:e=3}={})=>{const t=[],n=[],s=[],a=[],i=1/e;for(let o=0;o<e+1;o++)for(let l=0;l<o+1;l++)n.push((2*l-o)*i/2,o*i,0),s.push(0,0,1),a.push(i*l,1-i*o);for(let o=1;o<e+1;o++)for(let l=0;l<o;l++){const u=o*(o+1)/2+l,c=o*(o-1)/2+l;if(t.push(u,c,u+1),o<e){const f=(o+1)*(o+2)/2+l;t.push(f+1,u,u+1)}}return{vertices:n,normals:s,uvs:a,indices:t}},Gn=`#include globals
#include fragment
`,$n=`#include globals
#include dimensions
