...
`),Object.entries({...ft,config:i}).forEach(([c,l])=>{t=t.replace(`#include ${c}`,l),n=n.replace(`#include ${c}`,l)}),[t,n].map(c=>vt(c,e.dimensions))},fe=(e,t,n,o,r)=>{if(e.gl.shaderSource(r,o),e.gl.compileShader(r),!e.gl.getShaderParameter(r,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(r);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},Ze=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},Nn=(e,t,n,o,r=[])=>{const{gl:i}=e,s=i.createProgram(),d=i.createShader(i.VERTEX_SHADER),m=i.createShader(i.FRAGMENT_SHADER);if(fe(e,t,"vertex",n,d)||fe(e,t,"fragment",o,m)||(i.attachShader(s,d),i.attachShader(s,m),Ze(e,t,s)))return;const c={program:s,vertexShader:d,fragmentShader:m,uniformsDef:r,recompile(l,f,h,v=null){fe(l,t,"vertex",f,this.vertexShader)||fe(l,t,"fragment",h,this.fragmentShader)||Ze(l,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(l))},bindUniforms(l){this.uniforms={},this.uniformsDef.forEach(({name:f,type:h,value:v})=>{this.uniforms[f]=ht(l,this.program,f,h),this.uniforms[f].update(v)})}};return c.bindUniforms(e),c},ie=(e,t,n,o,r,i=null,s=null)=>{const{gl:d}=e;s=s||d.FLOAT;const m=s===d.FLOAT?4:2,c={name:n,mesh:t,indices:wn,instances:i,data:r,size:o,type:s,update(l=null,f=null,h=null){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer),l===null&&f===null&&h===null?d.bufferData(d.ARRAY_BUFFER,this.data,d.STATIC_DRAW):(this.data.set(l,f*this.size),d.bufferSubData(d.ARRAY_BUFFER,f*this.size*m,this.data,f*this.size,h*this.size))},extend(l,f,h=!1){if(d.bindVertexArray(this.mesh.vao),this.size=l,f&&(h&&f.length>=this.data.length&&f.set(this.data),this.data=f),this.location=d.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const v=l>4?3:1;for(let p=0;p<v;p++)d.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)d.vertexAttribPointer(this.location+p,l/v,this.type,!1,l*m,l/v*p*m);for(let p=0;p<v;p++)d.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const l=new Float32Array(this.data.length);return d.getBufferSubData(d.ARRAY_BUFFER,0,l),l}};return c.buffer=d.createBuffer(),c.extend(o),c},wn=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const r=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,r),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:r,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},ht=(e,t,n,o)=>{const{gl:r}=e;return{program:t,update(s){if(r.useProgram(this.program),!o.startsWith("m0"))if(o.startsWith("m1")&&(o=o.replace("m","")),o.startsWith("m")){const d=parseInt(o.slice(1,2));if(d>4)for(let m=0;m<d;m++){const c=r.getUniformLocation(t,`${n}.c${m+1}.v`);if(c!==null&&r.uniform4fv(c,s[m][0]),d-4===1){const l=r.getUniformLocation(t,`${n}.c${m+1}.u`);l!==null&&r.uniform1f(l,s[m][1])}else if(d-4>1){const l=r.getUniformLocation(t,`${n}.c${m+1}.u`);if(l!==null&&r[`uniform${q(d-4,4)}fv`](l,s[m][1]),d-8===1){const f=r.getUniformLocation(t,`${n}.c${m+1}.t`);f!==null&&r.uniform1f(f,s[m][2])}}}else{const m=r.getUniformLocation(t,n);m!==null&&r[`uniformMatrix${o.slice(1)}`](m,!1,s)}}else{const d=r.getUniformLocation(t,n);d!==null&&r[`uniform${o}`](d,s)}},get(){r.useProgram(this.program);const s=r.getUniformLocation(t,n);if(s!==null)return r.getUniform(this.program,s)}}},X=(e,t,n=null)=>{const{gl:o}=e,r=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,r,i),{texture:s,width:r,height:i}},ne={},le=["texture","normal","displacement"],gt=(e,t,n)=>{const{gl:o}=e,r={width:4096,height:4096,listeners:[]};for(let i=0;i<le.length;i++){o.activeTexture(o[`TEXTURE${n+i}`]);const s=le[i];r[s]=o.createTexture(),o.bindTexture(o.TEXTURE_2D,r[le[i]]);const d=`textures/${t}/${s}.jpg`;let m=ne[d]||null;if(o.bindTexture(o.TEXTURE_2D,r.texture),o.texImage2D(o.TEXTURE_2D,0,o.RGBA,r.width,r.height,0,o.RGBA,o.UNSIGNED_BYTE,m!=null&&m.complete?m:null),m||(m=new Image,m.src=d,ne[d]=m),!m.complete){const c=()=>{r.listeners.splice(r.listeners.findIndex(([l])=>l===m),1),ne[d]=m,o.activeTexture(o[`TEXTURE${n+i}`]),o.bindTexture(o.TEXTURE_2D,r[s]),o.texImage2D(o.TEXTURE_2D,0,o.RGBA,o.RGBA,o.UNSIGNED_BYTE,m),ne[d]=null,o.generateMipmap(o.TEXTURE_2D),Y(e)};m.addEventListener("load",c),r.listeners.push([m,c])}}return r},xt=(e,t)=>{const{gl:n}=e;for(let o=0;o<le.length;o++){const r=le[o];n.deleteTexture(t[r])}},Qe=(e,t,n)=>{const{gl:o}=e;o.activeTexture(o[`TEXTURE${n}`]);const r={texture:o.createTexture(),width:2048,height:2048,listeners:[]};o.bindTexture(o.TEXTURE_CUBE_MAP,r.texture);const i=Object.entries({px:o.TEXTURE_CUBE_MAP_POSITIVE_X,nx:o.TEXTURE_CUBE_MAP_NEGATIVE_X,py:o.TEXTURE_CUBE_MAP_POSITIVE_Y,ny:o.TEXTURE_CUBE_MAP_NEGATIVE_Y,pz:o.TEXTURE_CUBE_MAP_POSITIVE_Z,nz:o.TEXTURE_CUBE_MAP_NEGATIVE_Z});for(let s=0;s<i.length;s++){const[d,m]=i[s],c=`cubemaps/${t}/${d}.jpg`;let l=ne[c]||null;if(o.texImage2D(m,0,o.RGBA,r.width,r.height,0,o.RGBA,o.UNSIGNED_BYTE,l),l||(l=new Image,l.src=c,ne[c]=l),!l.complete){const f=()=>{r.listeners.splice(r.listeners.findIndex(([h])=>h===l),1),ne[c]=l,o.activeTexture(o[`TEXTURE${n}`]),o.bindTexture(o.TEXTURE_CUBE_MAP,r.texture),o.texImage2D(m,0,o.RGBA,o.RGBA,o.UNSIGNED_BYTE,l),o.generateMipmap(o.TEXTURE_CUBE_MAP),Y(e)};l.addEventListener("load",f),r.listeners.push([l,f])}}return o.generateMipmap(o.TEXTURE_CUBE_MAP),r},Me=e=>{e.listeners.forEach(([t,n])=>{t.removeEventListener("load",n)}),e.listeners=[]},ae=(e,t,n,o,r=[])=>{const i={name:t,vertex:n,fragment:o,...Nn(e,t,n,o,r),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,r)}};return{[t]:i}},je=(e,t,n,o,r,i,s,d=["position"])=>{var h;const{gl:m}=e,c=r(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),l=v=>[{name:"viewProjection",type:"m4fv",value:G(te(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:G(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:G(te(v.dimensions))},{name:"zoom",type:"1f",value:1},{name:"envMap",type:"1i",value:3},{name:"textureMap",type:"1i",value:4},{name:"normalMap",type:"1i",value:5},{name:"displacementMap",type:"1i",value:6},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...J(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];s=Ke(s);const f={attributes:{},varying:d,vertex:n,type:t,fragment:o,...Nn(e,t,...Ye(e,n,o,t),l(e)),recompileProgram(v){const[p,b]=Ye(v,this.vertex,this.fragment,this.type);this.recompile(v,p,b,l(v))},changeArity(v){v=Ke(v),this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,d.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=r(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillGeometry(v,p){if(p.arity===this.arity){this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count);for(let b=0;b<this.varying.length;b++){const w=this.varying[b];this.attributes[w].update(v[b],p.start,p.size)}}},fillColor(v,p){p.arity===this.arity&&(this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v,p.start,p.size))},render(v){if(!this.count)return;const{gl:p}=v;p.useProgram(this.program),p.bindVertexArray(this.vao),p.drawElementsInstanced(p.TRIANGLES,this.indices.count,p.UNSIGNED_SHORT,0,this.count)}};return f.vao=m.createVertexArray(),f.indices=wn(e,f.vao,new Uint16Array(c.indices)),f.attributes.vertex=ie(e,f,"vertex",3,new Float32Array(c.vertices)),f.attributes.uv=ie(e,f,"uv",2,new Float32Array(c.uvs)),f.attributes.normal=ie(e,f,"normal",3,new Float32Array(c.normals)),f.attributes.color=ie(e,f,"color",3,new Float32Array(i*3),1),d.forEach(v=>{f.attributes[v]=ie(e,f,v,s,new Float32Array(i*s),1)}),f.type=t,f.arity=s,f.instances=i,f.count=0,{[t]:f}},Oe=(e,t,n,o)=>{const{gl:r}=e;r.bindRenderbuffer(r.RENDERBUFFER,t),o?r.renderbufferStorageMultisample(r.RENDERBUFFER,o,n,r.drawingBufferWidth,r.drawingBufferHeight):r.renderbufferStorage(r.RENDERBUFFER,n,r.drawingBufferWidth,r.drawingBufferHeight),r.bindRenderbuffer(r.RENDERBUFFER,null)},bt=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],r=[],i=[],s=[];let d=0;const m=[];for(let c=0;c<=n;c++){const l=[],f=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,b=[-e*Re(p*De)*pe(f*K),e*Re(f*K),e*pe(p*De)*pe(f*K)];r.push(...b);const w=(b[0]**2+b[1]**2+b[2]**2)**-.5;i.push(...b.map(N=>N*w)),s.push(p+h,1-f),l.push(d++)}m.push(l)}for(let c=0;c<n;c++)for(let l=0;l<t;l++){const f=m[c][l+1],h=m[c][l],v=m[c+1][l],p=m[c+1][l+1];c!==0&&o.push(f,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:r,normals:i,uvs:s,indices:o}},Et=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:r=8,segments:i=1}={})=>{const s=[],d=[],m=[],c=[];e!==null&&(t=e,n=e);let l=0;const f=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const b=[],w=p/i,N=w*(n-t)+t;for(let j=0;j<=r;j++){const T=j/r,D=T*De,B=pe(D),L=Re(D),se=[N*B,-w*o+h,N*L];d.push(...se);const P=[B,v,L],k=(P[0]**2+P[1]**2+P[2]**2)**-.5;m.push(...P.map(ye=>ye*k)),c.push(T,1-w),b.push(l++)}f.push(b)}for(let p=0;p<r;p++)for(let b=0;b<i;b++){const w=f[b][p],N=f[b+1][p],j=f[b+1][p+1],T=f[b][p+1];s.push(w,N,T),s.push(N,j,T)}return{vertices:d,normals:m,uvs:c,indices:s}},Nt=({segments:e=3}={})=>{const t=[],n=[],o=[],r=[],i=1/e;for(let s=0;s<e+1;s++)for(let d=0;d<s+1;d++)n.push((2*d-s)*i/2,s*i,0),o.push(0,0,1),r.push(i*d,1-i*s);for(let s=1;s<e+1;s++)for(let d=0;d<s;d++){const m=s*(s+1)/2+d,c=s*(s-1)/2+d;if(t.push(m,c,m+1),s<e){const l=(s+1)*(s+2)/2+d;t.push(l+1,m,m+1)}}return{vertices:n,normals:o,uvs:r,indices:t}},wt=`#include globals
#include fragment
`,yt=`#include globals
#include dimensions
