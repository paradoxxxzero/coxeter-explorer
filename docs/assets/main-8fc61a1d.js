...
#endif
`,Be=e=>e>4?9:e<1?1:e,qn={globals:Vn,dimensions:Bn,project:Kn,helpers:Gn,complex:Un,fragment:$n,vertexouthead:Xn,lighting:Jn,vertexout:Wn},Yn=(e,t,n)=>{t=n?1:t||1,t=Math.max(0,t);const o=n?n.width:e.clientWidth*t|0,r=n?n.height:e.clientHeight*t|0;return e.width!==o||e.height!==r?(e.width=o,e.height=r,!0):!!n},Ne=(e,t)=>e.replace(/\bvecN\b/g,`vec${t}`).replace(/\bmatN\b/g,`mat${t}`).replace(/\bfovN\b/g,`fov${t}`).replace(/\bvecN_1\b/g,`vec${t-1}`).replace(/\bvec1\b/g,"float").replace(/\b_N_\b/g,`${t}`).replace(/\b_Nf_\b/g,`${t}.`).replace(/\PROJECTION_N\b/g,`PROJECTION${t}`).replace(/\bvec[01]\b/g,"float").replace(/\bmat[01]\b/g,"float"),Zn=(e,t)=>Ne(e.replace(/#loopN(\d)(.+?)#endloopN/gs,(n,o,r)=>{const i=[];for(let s=o;s<=t;s++)i.push(Ne(r.replace(/#ifN(\d)(.+?)(#elseN(.+?)):?#endifN/gs,(l,f,c,d,m)=>f===`${s}`?Ne(c,s):m||""),s));return i.join(`
`)}),t),$e=(e,t,n,o)=>{var f;const r=te[e.ambiance];let i="";const s=c=>c.toString().includes(".")?c:`${c}.`;Object.entries({shading:c=>zn.indexOf(c),diffuse:c=>Pn.indexOf(c),specular:c=>Mn.indexOf(c),ambient:c=>s(c),shininess:c=>s(c),roughness:c=>s(c),opacity:c=>s(c),gouraud:c=>""}).forEach(([c,d])=>{const m=Object.keys(r).includes(o)&&Object.keys(r[o]).includes(c)?r[o][c]:r[c];m!==!1&&(i+=`#define ${c.toUpperCase()} ${d(m)}
`),c==="opacity"&&m<1&&(r.transparent[o]=!0,i+=`#define TRANSPARENT
`,r.transparency==="oit"&&(i+=`#define OIT
`))}),i+=`#define DIMENSIONS ${e.dimensions}
`;for(let c=3;c<=e.dimensions;c++)i+=`#define PROJECTION${c} ${an.indexOf(e[`projection${c}`])-1}
`;return i+=`#define CURVATURE ${((f=e.space)==null?void 0:f.curvature)||0}
`,e.curve&&(i+=`#define SEGMENTS
`),Object.entries({...qn,config:i}).forEach(([c,d])=>{t=t.replace(`#include ${c}`,d),n=n.replace(`#include ${c}`,d)}),[t,n].map(c=>Zn(c,e.dimensions))},le=(e,t,n,o,r)=>{if(e.gl.shaderSource(r,o),e.gl.compileShader(r),!e.gl.getShaderParameter(r,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(r);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},Ve=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},on=(e,t,n,o,r=[])=>{const{gl:i}=e,s=i.createProgram(),l=i.createShader(i.VERTEX_SHADER),f=i.createShader(i.FRAGMENT_SHADER);if(le(e,t,"vertex",n,l)||le(e,t,"fragment",o,f)||(i.attachShader(s,l),i.attachShader(s,f),Ve(e,t,s)))return;const c={program:s,vertexShader:l,fragmentShader:f,uniformsDef:r,recompile(d,m,h,v=null){le(d,t,"vertex",m,this.vertexShader)||le(d,t,"fragment",h,this.fragmentShader)||Ve(d,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(d))},bindUniforms(d){this.uniforms={},this.uniformsDef.forEach(({name:m,type:h,value:v})=>{this.uniforms[m]=Qn(d,this.program,m,h),this.uniforms[m].update(v)})}};return c.bindUniforms(e),c},re=(e,t,n,o,r,i=null,s=null)=>{const{gl:l}=e;s=s||l.FLOAT;const f=s===l.FLOAT?4:2,c={name:n,mesh:t,indices:sn,instances:i,data:r,size:o,type:s,update(d=null,m=null,h=null){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer),d===null&&m===null&&h===null?l.bufferData(l.ARRAY_BUFFER,this.data,l.STATIC_DRAW):(this.data.set(d,m*this.size),l.bufferSubData(l.ARRAY_BUFFER,m*this.size*f,this.data,m*this.size,h*this.size))},extend(d,m,h=!1){if(l.bindVertexArray(this.mesh.vao),this.size=d,m&&(h&&m.length>=this.data.length&&m.set(this.data),this.data=m),this.location=l.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const v=d>4?3:1;for(let p=0;p<v;p++)l.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)l.vertexAttribPointer(this.location+p,d/v,this.type,!1,d*f,d/v*p*f);for(let p=0;p<v;p++)l.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){l.bindVertexArray(this.mesh.vao),l.bindBuffer(l.ARRAY_BUFFER,this.buffer);const d=new Float32Array(this.data.length);return l.getBufferSubData(l.ARRAY_BUFFER,0,d),d}};return c.buffer=l.createBuffer(),c.extend(o),c},sn=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const r=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,r),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:r,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},Qn=(e,t,n,o)=>{const{gl:r}=e;return{program:t,update(s){if(r.useProgram(this.program),!o.startsWith("m0"))if(o.startsWith("m1")&&(o=o.replace("m","")),o.startsWith("m")){const l=parseInt(o.slice(1,2));if(l>4)for(let f=0;f<l;f++){const c=r.getUniformLocation(t,`${n}.c${f+1}.v`);if(c!==null&&r.uniform4fv(c,s[f][0]),l-4===1){const d=r.getUniformLocation(t,`${n}.c${f+1}.u`);d!==null&&r.uniform1f(d,s[f][1])}else if(l-4>1){const d=r.getUniformLocation(t,`${n}.c${f+1}.u`);if(d!==null&&r[`uniform${$(l-4,4)}fv`](d,s[f][1]),l-8===1){const m=r.getUniformLocation(t,`${n}.c${f+1}.t`);m!==null&&r.uniform1f(m,s[f][2])}}}else{const f=r.getUniformLocation(t,n);f!==null&&r[`uniformMatrix${o.slice(1)}`](f,!1,s)}}else{const l=r.getUniformLocation(t,n);l!==null&&r[`uniform${o}`](l,s)}},get(){r.useProgram(this.program);const s=r.getUniformLocation(t,n);if(s!==null)return r.getUniform(this.program,s)}}},G=(e,t,n=null)=>{const{gl:o}=e,r=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,r,i),{texture:s,width:r,height:i}},oe=(e,t,n,o,r=[])=>{const i={name:t,vertex:n,fragment:o,...on(e,t,n,o,r),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,r)}};return{[t]:i}},we=(e,t,n,o,r,i,s,l=["position"])=>{var h;const{gl:f}=e,c=r(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),d=v=>[{name:"viewProjection",type:"m4fv",value:Y(Z(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:Y(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:Y(Z(v.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...J(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];s=Be(s);const m={attributes:{},varying:l,vertex:n,type:t,fragment:o,...on(e,t,...$e(e,n,o,t),d(e)),recompileProgram(v){const[p,E]=$e(v,this.vertex,this.fragment,this.type);this.recompile(v,p,E,d(v))},changeArity(v){v=Be(v),this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,l.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=r(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillData(v,p){if(!p){this.count=0;return}this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v[0],p.start,p.size);for(let E=0;E<this.varying.length;E++){const D=this.varying[E];this.attributes[D].update(v[E+1],p.start,p.size)}},render(v){this.count&&(f.useProgram(this.program),f.bindVertexArray(this.vao),f.drawElementsInstanced(f.TRIANGLES,this.indices.count,f.UNSIGNED_SHORT,0,this.count))}};return m.vao=f.createVertexArray(),m.indices=sn(e,m.vao,new Uint16Array(c.indices)),m.attributes.vertex=re(e,m,"vertex",3,new Float32Array(c.vertices)),m.attributes.uv=re(e,m,"uv",2,new Float32Array(c.uvs)),m.attributes.normal=re(e,m,"normal",3,new Float32Array(c.normals)),m.attributes.color=re(e,m,"color",3,new Float32Array(i*3),1),l.forEach(v=>{m.attributes[v]=re(e,m,v,s,new Float32Array(i*s),1)}),m.type=t,m.arity=s,m.instances=i,m.count=0,{[t]:m}},Se=(e,t,n,o)=>{const{gl:r}=e;r.bindRenderbuffer(r.RENDERBUFFER,t),o?r.renderbufferStorageMultisample(r.RENDERBUFFER,o,n,r.drawingBufferWidth,r.drawingBufferHeight):r.renderbufferStorage(r.RENDERBUFFER,n,r.drawingBufferWidth,r.drawingBufferHeight),r.bindRenderbuffer(r.RENDERBUFFER,null)},et=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],r=[],i=[],s=[];let l=0;const f=[];for(let c=0;c<=n;c++){const d=[],m=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,E=[-e*je(p*Ie)*de(m*W),e*je(m*W),e*de(p*Ie)*de(m*W)];r.push(...E);const D=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(w=>w*D)),s.push(p+h,1-m),d.push(l++)}f.push(d)}for(let c=0;c<n;c++)for(let d=0;d<t;d++){const m=f[c][d+1],h=f[c][d],v=f[c+1][d],p=f[c+1][d+1];c!==0&&o.push(m,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:r,normals:i,uvs:s,indices:o}},nt=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:r=8,segments:i=1}={})=>{const s=[],l=[],f=[],c=[];e!==null&&(t=e,n=e);let d=0;const m=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const E=[],D=p/i,w=D*(n-t)+t;for(let R=0;R<=r;R++){const y=R/r,z=y*Ie,U=de(z),k=je(z),ae=[w*U,-D*o+h,w*k];l.push(...ae);const M=[U,v,k],_=(M[0]**2+M[1]**2+M[2]**2)**-.5;f.push(...M.map(xe=>xe*_)),c.push(y,1-D),E.push(d++)}m.push(E)}for(let p=0;p<r;p++)for(let E=0;E<i;E++){const D=m[E][p],w=m[E+1][p],R=m[E+1][p+1],y=m[E][p+1];s.push(D,w,y),s.push(w,R,y)}return{vertices:l,normals:f,uvs:c,indices:s}},tt=({segments:e=3}={})=>{const t=[],n=[],o=[],r=[],i=1/e;for(let s=0;s<e+1;s++)for(let l=0;l<s+1;l++)n.push((2*l-s)*i/2,s*i,0),o.push(0,0,1),r.push(i*l,1-i*s);for(let s=1;s<e+1;s++)for(let l=0;l<s;l++){const f=s*(s+1)/2+l,c=s*(s-1)/2+l;if(t.push(f,c,f+1),s<e){const d=(s+1)*(s+2)/2+l;t.push(d+1,f,f+1)}}return{vertices:n,normals:o,uvs:r,indices:t}},at=`#include globals
#include fragment
`,rt=`#include globals
#include dimensions
