 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kf=K,If=Symbol.for("react.element"),Tf=Symbol.for("react.fragment"),Rf=Object.prototype.hasOwnProperty,_f=kf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Cf={key:!0,ref:!0,__self:!0,__source:!0};function Gs(e,n,t){var r,i={},o=null,l=null;t!==void 0&&(o=""+t),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(l=n.ref);for(r in n)Rf.call(n,r)&&!Cf.hasOwnProperty(r)&&(i[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)i[r]===void 0&&(i[r]=n[r]);return{$$typeof:If,type:e,key:o,ref:l,props:i,_owner:_f.current}}Ti.Fragment=Tf;Ti.jsx=Gs;Ti.jsxs=Gs;Fs.exports=Ti;var T=Fs.exports,xu={},Qs={exports:{}},Se={},Ks={exports:{}},Xs={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(_,C){var O=_.length;_.push(C);e:for(;0<O;){var G=O-1>>>1,q=_[G];if(0<i(q,C))_[G]=C,_[O]=q,O=G;else break e}}function t(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var C=_[0],O=_.pop();if(O!==C){_[0]=O;e:for(var G=0,q=_.length,xr=q>>>1;G<xr;){var _n=2*(G+1)-1,Gi=_[_n],Cn=_n+1,Er=_[Cn];if(0>i(Gi,O))Cn<q&&0>i(Er,Gi)?(_[G]=Er,_[Cn]=O,G=Cn):(_[G]=Gi,_[_n]=O,G=_n);else if(Cn<q&&0>i(Er,O))_[G]=Er,_[Cn]=O,G=Cn;else break e}}return C}function i(_,C){var O=_.sortIndex-C.sortIndex;return O!==0?O:_.id-C.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,u=l.now();e.unstable_now=function(){return l.now()-u}}var s=[],a=[],f=1,c=null,d=3,v=!1,m=!1,y=!1,E=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(_){for(var C=t(a);C!==null;){if(C.callback===null)r(a);else if(C.startTime<=_)r(a),C.sortIndex=C.expirationTime,n(s,C);else break;C=t(a)}}function x(_){if(y=!1,g(_),!m)if(t(s)!==null)m=!0,Vi(S);else{var C=t(a);C!==null&&Wi(x,C.startTime-_)}}function S(_,C){m=!1,y&&(y=!1,h(k),k=-1),v=!0;var O=d;try{for(g(C),c=t(s);c!==null&&(!(c.expirationTime>C)||_&&!Oe());){var G=c.callback;if(typeof G=="function"){c.callback=null,d=c.priorityLevel;var q=G(c.expirationTime<=C);C=e.unstable_now(),typeof q=="function"?c.callback=q:c===t(s)&&r(s),g(C)}else r(s);c=t(s)}if(c!==null)var xr=!0;else{var _n=t(a);_n!==null&&Wi(x,_n.startTime-C),xr=!1}return xr}finally{c=null,d=O,v=!1}}var I=!1,N=null,k=-1,A=5,P=-1;function Oe(){return!(e.unstable_now()-P<A)}function St(){if(N!==null){var _=e.unstable_now();P=_;var C=!0;try{C=N(!0,_)}finally{C?wt():(I=!1,N=null)}}else I=!1}var wt;if(typeof p=="function")wt=function(){p(St)};else if(typeof MessageChannel<"u"){var hu=new MessageChannel,lf=hu.port2;hu.port1.onmessage=St,wt=function(){lf.postMessage(null)}}else wt=function(){E(St,0)};function Vi(_){N=_,I||(I=!0,wt())}function Wi(_,C){k=E(function(){_(e.unstable_now())},C)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){m||v||(m=!0,Vi(S))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return d},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(_){switch(d){case 1:case 2:case 3:var C=3;break;default:C=d}var O=d;d=C;try{return _()}finally{d=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,C){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var O=d;d=_;try{return C()}finally{d=O}},e.unstable_scheduleCallback=function(_,C,O){var G=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?G+O:G):O=G,_){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=O+q,_={id:f++,callback:C,priorityLevel:_,startTime:O,expirationTime:q,sortIndex:-1},O>G?(_.sortIndex=O,n(a,_),t(s)===null&&_===t(a)&&(y?(h(k),k=-1):y=!0,Wi(x,O-G))):(_.sortIndex=q,n(s,_),m||v||(m=!0,Vi(S))),_},e.unstable_shouldYield=Oe,e.unstable_wrapCallback=function(_){var C=d;return function(){var O=d;d=C;try{return _.apply(this,arguments)}finally{d=O}}}})(Xs);Ks.exports=Xs;var Of=Ks.exports;/**
 * @license React
...
`,$p=`gl_Position = viewProject(proj);
...
#endif
`,Hp={globals:Ap,dimensions:zp,project:jp,helpers:Fp,complex:Dp,ease:Mp,fragment:Up,vertexouthead:Bp,lighting:Lp,vertexout:$p},So=(e,n,t)=>(t<0&&(t+=1),t>1&&(t-=1),t<1/6?e+(n-e)*6*t:t<1/2?n:t<2/3?e+(n-e)*(2/3-t)*6:e),me=(e,n,t)=>{let r,i,o;if(n===0)r=i=o=t;else{const l=t<.5?t*(1+n):t+n-t*n,u=2*t-l;r=So(u,l,e+1/3),i=So(u,l,e),o=So(u,l,e-1/3)}return[r,i,o]},Vp=(e,n)=>{n=n||1,n=Math.max(0,n);const t=e.clientWidth*n|0,r=e.clientHeight*n|0;return e.width!==t||e.height!==r?(e.width=t,e.height=r,!0):!1},wo=(e,n)=>e.replace(/\bvecN\b/g,`vec${n}`).replace(/\bmatN\b/g,`mat${n}`).replace(/\bfovN\b/g,`fov${n}`).replace(/\bvecN_1\b/g,`vec${n-1}`).replace(/\bvec1\b/g,"float").replace(/\b_N_\b/g,`${n}`).replace(/\b_Nf_\b/g,`${n}.`).replace(/\PROJECTION_N\b/g,`PROJECTION${n}`),Wp=(e,n)=>wo(e.replace(/#loopN(\d)(.+?)#endloopN/gs,(t,r,i)=>{const o=[];for(let l=r;l<=n;l++)o.push(wo(i.replace(/#ifN(\d)(.+?)(#elseN(.+?)):?#endifN/gs,(u,s,a,f,c)=>s===`${l}`?wo(a,l):c||""),l));return o.join(`
`)}),n),Cs=(e,n,t,r)=>{var a;const i=yr[e.ambiance];let o="";const l=f=>f.toString().includes(".")?f:`${f}.`;Object.entries({shading:f=>Yp.indexOf(f),diffuse:f=>qp.indexOf(f),specular:f=>Zp.indexOf(f),ambient:f=>l(f),shininess:f=>l(f),roughness:f=>l(f),opacity:f=>l(f),gouraud:f=>""}).forEach(([f,c])=>{const d=Object.keys(i).includes(r)&&Object.keys(i[r]).includes(f)?i[r][f]:i[f];d!==!1&&(o+=`#define ${f.toUpperCase()} ${c(d)}
