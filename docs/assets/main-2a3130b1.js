...
`),Object.entries({...Zn,config:i}).forEach(([c,l])=>{t=t.replace(`#include ${c}`,l),n=n.replace(`#include ${c}`,l)}),[t,n].map(c=>et(c,e.dimensions))},de=(e,t,n,o,r)=>{if(e.gl.shaderSource(r,o),e.gl.compileShader(r),!e.gl.getShaderParameter(r,e.gl.COMPILE_STATUS)){const s=e.gl.getShaderInfoLog(r);return console.error(`An error occurred compiling the ${t}->${n} shader: ${s}`,{shaderSource:o}),s}},Be=(e,t,n)=>{const{gl:o}=e;if(o.linkProgram(n),!o.getProgramParameter(n,o.LINK_STATUS)){const i=o.getProgramInfoLog(n);return console.error(`Unable to initialize the ${t} shader program: ${i}`),i}},cn=(e,t,n,o,r=[])=>{const{gl:i}=e,s=i.createProgram(),d=i.createShader(i.VERTEX_SHADER),m=i.createShader(i.FRAGMENT_SHADER);if(de(e,t,"vertex",n,d)||de(e,t,"fragment",o,m)||(i.attachShader(s,d),i.attachShader(s,m),Be(e,t,s)))return;const c={program:s,vertexShader:d,fragmentShader:m,uniformsDef:r,recompile(l,f,h,v=null){de(l,t,"vertex",f,this.vertexShader)||de(l,t,"fragment",h,this.fragmentShader)||Be(l,t,this.program)||(v&&(this.uniformsDef=v),this.bindUniforms(l))},bindUniforms(l){this.uniforms={},this.uniformsDef.forEach(({name:f,type:h,value:v})=>{this.uniforms[f]=nt(l,this.program,f,h),this.uniforms[f].update(v)})}};return c.bindUniforms(e),c},re=(e,t,n,o,r,i=null,s=null)=>{const{gl:d}=e;s=s||d.FLOAT;const m=s===d.FLOAT?4:2,c={name:n,mesh:t,indices:ln,instances:i,data:r,size:o,type:s,update(l=null,f=null,h=null){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer),l===null&&f===null&&h===null?d.bufferData(d.ARRAY_BUFFER,this.data,d.STATIC_DRAW):(this.data.set(l,f*this.size),d.bufferSubData(d.ARRAY_BUFFER,f*this.size*m,this.data,f*this.size,h*this.size))},extend(l,f,h=!1){if(d.bindVertexArray(this.mesh.vao),this.size=l,f&&(h&&f.length>=this.data.length&&f.set(this.data),this.data=f),this.location=d.getAttribLocation(this.mesh.program,this.name),this.location===-1)return;d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const v=l>4?3:1;for(let p=0;p<v;p++)d.enableVertexAttribArray(this.location+p);for(let p=0;p<v;p++)d.vertexAttribPointer(this.location+p,l/v,this.type,!1,l*m,l/v*p*m);for(let p=0;p<v;p++)d.vertexAttribDivisor(this.location+p,this.instances||0);this.update()},get(){d.bindVertexArray(this.mesh.vao),d.bindBuffer(d.ARRAY_BUFFER,this.buffer);const l=new Float32Array(this.data.length);return d.getBufferSubData(d.ARRAY_BUFFER,0,l),l}};return c.buffer=d.createBuffer(),c.extend(o),c},ln=(e,t,n)=>{const{gl:o}=e;o.bindVertexArray(t);const r=o.createBuffer();return o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,r),o.bufferData(o.ELEMENT_ARRAY_BUFFER,n,o.STATIC_DRAW),{buffer:r,vao:t,indices:n,count:n.length,update(i){o.bindVertexArray(this.vao),this.indices=i,this.count=i.length,o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.buffer),o.bufferData(o.ELEMENT_ARRAY_BUFFER,i,o.STATIC_DRAW)}}},nt=(e,t,n,o)=>{const{gl:r}=e;return{program:t,update(s){if(r.useProgram(this.program),!o.startsWith("m0"))if(o.startsWith("m1")&&(o=o.replace("m","")),o.startsWith("m")){const d=parseInt(o.slice(1,2));if(d>4)for(let m=0;m<d;m++){const c=r.getUniformLocation(t,`${n}.c${m+1}.v`);if(c!==null&&r.uniform4fv(c,s[m][0]),d-4===1){const l=r.getUniformLocation(t,`${n}.c${m+1}.u`);l!==null&&r.uniform1f(l,s[m][1])}else if(d-4>1){const l=r.getUniformLocation(t,`${n}.c${m+1}.u`);if(l!==null&&r[`uniform${V(d-4,4)}fv`](l,s[m][1]),d-8===1){const f=r.getUniformLocation(t,`${n}.c${m+1}.t`);f!==null&&r.uniform1f(f,s[m][2])}}}else{const m=r.getUniformLocation(t,n);m!==null&&r[`uniformMatrix${o.slice(1)}`](m,!1,s)}}else{const d=r.getUniformLocation(t,n);d!==null&&r[`uniform${o}`](d,s)}},get(){r.useProgram(this.program);const s=r.getUniformLocation(t,n);if(s!==null)return r.getUniform(this.program,s)}}},G=(e,t,n=null)=>{const{gl:o}=e,r=n?~~(n*o.drawingBufferWidth):o.drawingBufferWidth,i=n?~~(n*o.drawingBufferHeight):o.drawingBufferHeight,s=o.createTexture();return o.bindTexture(o.TEXTURE_2D,s),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,n?o.LINEAR:o.NEAREST),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texStorage2D(o.TEXTURE_2D,1,t,r,i),{texture:s,width:r,height:i}},oe=(e,t,n,o,r=[])=>{const i={name:t,vertex:n,fragment:o,...cn(e,t,n,o,r),recompileProgram(s){this.recompile(s,this.vertex,this.fragment,r)}};return{[t]:i}},we=(e,t,n,o,r,i,s,d=["position"])=>{var h;const{gl:m}=e,c=r(((h=e.space)==null?void 0:h.curvature)&&e.curve,e.detail),l=v=>[{name:"viewProjection",type:"m4fv",value:Z(Q(4))},{name:"matrix",type:`m${v.dimensions}fv`,value:Z(v.matrix)},{name:"eye",type:"3fv",value:[0,0,0]},{name:"metric",type:`m${v.dimensions}fv`,value:Z(Q(v.dimensions))},{name:"zoom",type:"1f",value:1},...["vertex","edge"].includes(t)?[{name:"thickness",type:"1f",value:0}]:[],...J(3,v.dimensions+1,1,!0).map(p=>({name:`fov${p}`,type:"1f",value:v[`fov${p}`]}))];s=He(s);const f={attributes:{},varying:d,vertex:n,type:t,fragment:o,...cn(e,t,...Ue(e,n,o,t),l(e)),recompileProgram(v){const[p,E]=Ue(v,this.vertex,this.fragment,this.type);this.recompile(v,p,E,l(v))},changeArity(v){v=He(v),this.arity!==v&&(this.arity=v,this.extendAttributes(this.instances))},extendAttributes(v){this.instances=v,d.forEach(p=>{this.attributes[p].extend(this.arity,new Float32Array(v*this.arity),!0)}),this.attributes.color.extend(3,new Float32Array(v*3),!0)},updateGeometry(v){const p=r(v.space.curvature&&v.curve,v.detail);this.indices.update(new Uint16Array(p.indices)),this.attributes.vertex.extend(3,new Float32Array(p.vertices)),this.attributes.uv.extend(2,new Float32Array(p.uvs)),this.attributes.normal.extend(3,new Float32Array(p.normals))},fillGeometry(v,p){if(p.arity===this.arity){this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count);for(let E=0;E<this.varying.length;E++){const C=this.varying[E];this.attributes[C].update(v[E],p.start,p.size)}}},fillColor(v,p){p.arity===this.arity&&(this.count=p.start+p.size,this.instances<this.count&&this.extendAttributes(this.count),this.attributes.color.update(v,p.start,p.size))},render(v){this.count&&(m.useProgram(this.program),m.bindVertexArray(this.vao),m.drawElementsInstanced(m.TRIANGLES,this.indices.count,m.UNSIGNED_SHORT,0,this.count))}};return f.vao=m.createVertexArray(),f.indices=ln(e,f.vao,new Uint16Array(c.indices)),f.attributes.vertex=re(e,f,"vertex",3,new Float32Array(c.vertices)),f.attributes.uv=re(e,f,"uv",2,new Float32Array(c.uvs)),f.attributes.normal=re(e,f,"normal",3,new Float32Array(c.normals)),f.attributes.color=re(e,f,"color",3,new Float32Array(i*3),1),d.forEach(v=>{f.attributes[v]=re(e,f,v,s,new Float32Array(i*s),1)}),f.type=t,f.arity=s,f.instances=i,f.count=0,{[t]:f}},Se=(e,t,n,o)=>{const{gl:r}=e;r.bindRenderbuffer(r.RENDERBUFFER,t),o?r.renderbufferStorageMultisample(r.RENDERBUFFER,o,n,r.drawingBufferWidth,r.drawingBufferHeight):r.renderbufferStorage(r.RENDERBUFFER,n,r.drawingBufferWidth,r.drawingBufferHeight),r.bindRenderbuffer(r.RENDERBUFFER,null)},tt=({radius:e=1,widthSegments:t=16,segments:n=16}={})=>{const o=[],r=[],i=[],s=[];let d=0;const m=[];for(let c=0;c<=n;c++){const l=[],f=c/n;let h=0;c===0?h=.5/t:c===n&&(h=-.5/t);for(let v=0;v<=t;v++){const p=v/t,E=[-e*Ie(p*Te)*ue(f*K),e*Ie(f*K),e*ue(p*Te)*ue(f*K)];r.push(...E);const C=(E[0]**2+E[1]**2+E[2]**2)**-.5;i.push(...E.map(S=>S*C)),s.push(p+h,1-f),l.push(d++)}m.push(l)}for(let c=0;c<n;c++)for(let l=0;l<t;l++){const f=m[c][l+1],h=m[c][l],v=m[c+1][l],p=m[c+1][l+1];c!==0&&o.push(f,h,p),c!==n-1&&o.push(h,v,p)}return{vertices:r,normals:i,uvs:s,indices:o}},at=({radius:e=null,radiusTop:t=1,radiusBottom:n=1,height:o=1,radialSegments:r=8,segments:i=1}={})=>{const s=[],d=[],m=[],c=[];e!==null&&(t=e,n=e);let l=0;const f=[],h=o/2,v=(n-t)/o;for(let p=0;p<=i;p++){const E=[],C=p/i,S=C*(n-t)+t;for(let D=0;D<=r;D++){const y=D/r,z=y*Te,U=ue(z),k=Ie(z),ae=[S*U,-C*o+h,S*k];d.push(...ae);const M=[U,v,k],_=(M[0]**2+M[1]**2+M[2]**2)**-.5;m.push(...M.map(xe=>xe*_)),c.push(y,1-C),E.push(l++)}f.push(E)}for(let p=0;p<r;p++)for(let E=0;E<i;E++){const C=f[E][p],S=f[E+1][p],D=f[E+1][p+1],y=f[E][p+1];s.push(C,S,y),s.push(S,D,y)}return{vertices:d,normals:m,uvs:c,indices:s}},rt=({segments:e=3}={})=>{const t=[],n=[],o=[],r=[],i=1/e;for(let s=0;s<e+1;s++)for(let d=0;d<s+1;d++)n.push((2*d-s)*i/2,s*i,0),o.push(0,0,1),r.push(i*d,1-i*s);for(let s=1;s<e+1;s++)for(let d=0;d<s;d++){const m=s*(s+1)/2+d,c=s*(s-1)/2+d;if(t.push(m,c,m+1),s<e){const l=(s+1)*(s+2)/2+d;t.push(l+1,m,m+1)}}return{vertices:n,normals:o,uvs:r,indices:t}},ot=`#include globals
#include fragment
`,st=`#include globals
#include dimensions
